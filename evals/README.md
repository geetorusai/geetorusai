...
Eval framework for testing Geetorus agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Geetorus heartbeat skill:
