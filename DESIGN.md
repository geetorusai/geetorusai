...
3. **Domain tier** — match-chip tokens `--chip-match-*`, annotation highlights `--geetorus-doc-annotation-highlight-*`, plus motion/typography tokens.
