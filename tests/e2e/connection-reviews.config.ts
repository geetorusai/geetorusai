...
const controlPath =
  process.env.GEETORUS_REVIEW_RESTART_FILE ??
  path.join(process.env.GEETORUS_HOME!, "connection-review-restart.txt");
process.env.GEETORUS_REVIEW_RESTART_FILE = controlPath;
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      GEETORUS_REVIEW_RESTART_FILE: controlPath,
    },
  },
});
