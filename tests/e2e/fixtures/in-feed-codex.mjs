...
const recoveryFixture = process.env.GEETORUS_RECOVERY_FIXTURE === "1";
...
async function finish(text, evidenceRef) {
  return call('geetorus_finish', { schema: 'geetorus.run_result.v1', reportedWorkDisposition: 'done', summary: text,
