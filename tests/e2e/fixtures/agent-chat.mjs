...
// No DB writes, mocked Geetorus responses, provider calls, or outside workspaces.
const base = process.env.GEETORUS_API_URL;
const headers = {
...
const run = await api(`/heartbeat-runs/${process.env.GEETORUS_RUN_ID}`);
