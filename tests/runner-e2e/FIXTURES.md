...
This still provides full isolation because every cell starts a new Geetorus
...
Every selected case runs in its own isolated Geetorus process, and independent
