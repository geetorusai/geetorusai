...
describe("runner E2E source provenance", () => {
  it("prefers the resolved target over result and workflow revision contexts", () => {
    expect(
      resolveRunnerE2ESource(
        ...
        {
          GEETORUS_RUNNER_E2E_SOURCE_SHA: "target-sha",
          GEETORUS_RUNNER_E2E_SOURCE_REF: "refs/heads/target",
      ...
      workflowRunUrl:
        "https://github.com/geetorusai/geetorus/actions/runs/123",
    });
  });
  ...
  it("falls back through retained result provenance, workflow context, and null", () => {
    expect(
      ...
      workflowRunUrl:
        "https://github.com/geetorusai/geetorus/actions/runs/456",
    });
