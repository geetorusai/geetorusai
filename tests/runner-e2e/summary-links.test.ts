  ...
  it("builds exact public, workflow, and artifact links", () => {
    expect(
      runnerE2ESummaryLinks({
        ...
        workflowRunUrl:
          "https://github.com/geetorusai/geetorus/actions/runs/34026735033",
      ...
      },
      {
        ...
        url: "https://github.com/geetorusai/geetorus/actions/runs/34026735033",
      },
      {
        kind: "artifacts",
        label: "Download the merged report and per-cell evidence",
        url: "https://github.com/geetorusai/geetorus/actions/runs/34026735033#artifacts",
