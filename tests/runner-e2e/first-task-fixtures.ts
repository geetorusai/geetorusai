import { normalizeGeetorusOperationalSkillPreference } from "../../packages/adapter-utils/src/server-utils.js";
...
export function firstTaskNativeRuntimePatch(
  ...
  return {
    ...
    adapterConfig: normalizeGeetorusOperationalSkillPreference(
      "geetorus_runner",
      config,
    ),
  };
