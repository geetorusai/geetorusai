...
function renderHistory(history: RunnerE2EHistoryIndex | undefined) {
  ...
  return `<section class="history-section" id="history">
    ...
    <div class="history-table-wrap"><table class="history-table"><thead><tr><th>Campaign</th><th>Geetorus SHA</th><th>Result</th><th>Tokens</th><th>Cost</th><th>Execution</th></tr></thead><tbody>${rows}</tbody></table></div>
...
<head>
  ...
  <title>${html(input.title)} · Geetorus</title>
  <style>
    ...
    :root {
      ...
      --idle-border: #a8aeb2;
      --radius: 8px;
      /* TaskChatBubble: right-aligned human bubbles use Geetorus's liveness blue. */
      ...
      --font-sans: "Geetorus Inter", Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
