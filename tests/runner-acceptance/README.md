...
Geetorus, a provider process, a browser, a remote environment, or a billable
model request.
...
- Geetorus Runner with Codex;
- Geetorus Runner with the qualified OpenCode model; and
- Geetorus Runner with the qualified ACPX Claude and Codex profiles.
...
Future fixture executors may emit `geetorus.runner-acceptance.result/v1`
