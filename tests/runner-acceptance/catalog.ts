...
const excludedBuiltInAdapterTypes = new Set(["geetorus_runner", "pi_local"]);
...
export const nativeAcceptanceProfiles: readonly RunnerAcceptanceProfile[] = [
  ...
  nativeProfile({
    id: "runner-opencode",
    label: "Geetorus Runner OpenCode",
    provider: "opencode",
  ...
  nativeProfile({
    ...
    label: "Geetorus Runner ACPX Claude",
    provider: "acpx",
  ...
  nativeProfile({
    ...
    label: "Geetorus Runner ACPX Codex",
    provider: "acpx",
