...
<!--
  ...
  specific change. Start with what Geetorus is, then narrow through the
...
<!--
  ...
  instance-local Geetorus references — ticket ids like PAPA-123 / PAP-224,
...
- [ ] I have not referenced internal/instance-local Geetorus issues or links (only public GitHub `#NNN` / `github.com/geetorusai/geetorus` URLs)
- [ ] My branch name describes the change (e.g. `docs/...`, `fix/...`) and contains no internal Geetorus ticket id or instance-derived details
- [ ] I have run tests locally and they pass
- [ ] I have added or updated tests where applicable
- [ ] I have updated relevant documentation to reflect my changes
- [ ] I have considered and documented any risks above
- [ ] All Geetorus CI gates are green
