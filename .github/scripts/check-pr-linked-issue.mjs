...
const ISSUE_PATTERNS = [
  ...
  /(?:^|[\s(])https:\/\/github\.com\/geetorusai\/geetorus\/issues\/\d+(?=$|[\s),:;!?]|[.](?![\w-]))/i,
  /(?<!\w)#\d+/,
];
...
const TEMPLATE_FIELDS = {
  bug: [
    ...
    ['Geetorus version', 'Geetorus version or commit', 'Version or commit', 'Version/commit'],
    ['Deployment mode'],
  ],
  feature: [
...
export function checkLinkedIssue(body, prTitle = '') {
  ...
  return {
    ...
    failures: passed ? [] : [
      ...
      '(https://github.com/geetorusai/geetorus/tree/master/.github/ISSUE_TEMPLATE). ' +
