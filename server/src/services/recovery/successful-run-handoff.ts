...
import { agentWakeupRequests, agents, heartbeatRuns, issues } from "@geetorusai/db";
import {
  isUuidLike,
...
export const SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY =
  "Geetorus needs a disposition before this issue can continue.";
export const SUCCESSFUL_RUN_HANDOFF_EXHAUSTED_NOTICE_BODY =
  "Geetorus could not resolve this issue's missing disposition automatically. The source assignment is unchanged and a board decision is required.";
...
export function buildSuccessfulRunHandoffInstruction(input: {
  ...
  return [
    ...
    "",
    "## What happened",
    "Your last run on this issue ended successfully, but the issue is still `in_progress` and has no valid disposition — Geetorus cannot tell whether the work is finished, blocked, or unfinished.",
    ...(report
      ? [
          "",
    ...
    "",
    "## Your options",
    "Choose **exactly one** outcome and perform the matching Geetorus action:",
    "",
