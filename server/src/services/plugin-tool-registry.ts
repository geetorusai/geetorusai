...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@geetorusai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: GeetorusPluginManifestV1, pluginDbId: string): void;
