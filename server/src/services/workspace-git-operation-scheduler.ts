...
import { setExpensiveWorkspaceGitExecutor } from "@geetorusai/adapter-utils/git-workspace-sync";
...
>> {
  return {
    concurrency: envInteger(env, "GEETORUS_WORKSPACE_GIT_SCAN_CONCURRENCY", DEFAULT_CONCURRENCY, 1, 16),
    queueCapacity: envInteger(env, "GEETORUS_WORKSPACE_GIT_SCAN_QUEUE_CAPACITY", DEFAULT_QUEUE_CAPACITY, 0, 1_024),
    timeoutMs: envInteger(env, "GEETORUS_WORKSPACE_GIT_SCAN_TIMEOUT_MS", DEFAULT_TIMEOUT_MS, 100, 120_000),
    defaultCacheTtlMs: envInteger(env, "GEETORUS_WORKSPACE_GIT_SCAN_CACHE_TTL_MS", DEFAULT_CACHE_TTL_MS, 0, 60_000),
  };
}
