import { parseHiddenSettingsList } from "@geetorusai/shared";
import { logger } from "../middleware/logger.js";

/**
 * Operator-hidden settings, from the `GEETORUS_HIDDEN_SETTINGS` env var
 ...
 */
export const HIDDEN_SETTINGS_ENV_KEY = "GEETORUS_HIDDEN_SETTINGS";
