...
import { companySecretBindings } from "@geetorusai/db";
import type { EnvSecretRefBinding, SecretProjectionClass, SecretVersionSelector } from "@geetorusai/shared";
import { envBindingSecretRefSchema } from "@geetorusai/shared";
import {
