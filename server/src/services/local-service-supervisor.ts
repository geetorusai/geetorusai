...
function getRuntimeServicesDir() {
  return path.resolve(resolveGeetorusInstanceRoot(), "runtime-services");
}

function getRuntimeServiceLogsDir() {
  return path.resolve(resolveGeetorusInstanceRoot(), "runtime-service-logs");
}
 ...
 * as spawn returns without tying the service's stdio lifetime to Geetorus's.
 */
