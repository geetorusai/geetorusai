 ...
 *   never executes on the tenant's Geetorus-operated container. Unlike
 ...
 *   rather than executing on Geetorus compute.
 */
...
export function evaluateExecutionAllowlist(
  ...
  // agent code must never run in-process / on the tenant's Geetorus
