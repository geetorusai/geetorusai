...
function workspace(
  ...
  return {
    ...
    cwd: "/repo/.geetorus/worktrees/PAP-16051",
    branchName: "PAP-16051-workspace-ready-notice",
    worktreePath: "/repo/.geetorus/worktrees/PAP-16051",
    warnings: [],
    created: true,
      ...
      sections: [
        {
          ...
          rows: [
            ...
            { type: "key_value", label: "CWD", value: "/repo/.geetorus/worktrees/PAP-16051" },
          ],
        },
        {
          title: "Services",
  ...
  it("includes a distinct worktree row and preserves the existing markdown body", () => {
    ...
    expect(buildWorkspaceReadyMetadata(input).sections[0]).toEqual({
      ...
      rows: [
        ...
        { type: "key_value", label: "Worktree", value: "/repo/.geetorus/worktrees/PAP-16051" },
      ],
    });
    expect(buildWorkspaceReadyComment(input)).toBe([
      ...
      "- CWD: `/repo/runtime`",
      "- Worktree: `/repo/.geetorus/worktrees/PAP-16051`",
