...
import type { Environment, EnvironmentLease } from "@geetorusai/shared";
import { adapterSupportsRemoteManagedEnvironments } from "@geetorusai/shared";
import {
  adapterExecutionTargetToRemoteSpec,
  type AdapterExecutionTarget,
  type SandboxLeaseAcquisition,
} from "@geetorusai/adapter-utils/execution-target";
import type { DuplexObservabilityRecorder } from "@geetorusai/adapter-utils/duplex-observability";
import {
  clampSpanLabel,
 ...
 * `geetorus.sandbox.startup.exec.*` allowlist. The command rides only as a
        ...
        ? {
            ...
            execute: async (commandInput) => {
              ...
              try {
                ...
                // `geetorus.sandbox.startup.exec.*` allowlist: the normalized
