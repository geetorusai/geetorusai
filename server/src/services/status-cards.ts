...
import { companySearchQuerySchema, STATUS_CARD_AGENT_MAX_CARDS } from "@geetorusai/shared";
...
function compileDescription(card: StatusCardRow, generationIssueId: string | null, hash: string) {
  ...
  return `Compile this status-card interest prompt into structured Geetorus company-search queries, then continue in the same run and write the first full summary.
