...
import { toolAccessAuditEvents, toolRuntimeSlots } from "@geetorusai/db";
import type { DeploymentExposure, DeploymentMode, ToolRuntimeSlotStatus } from "@geetorusai/shared";
  ...
  async function getOrCreateSlot(input: {
    ...
    const [created] = await db
      ...
      .values({
        ...
        provider: "geetorus",
        providerRef: null,
        commandTemplateKey: input.commandTemplateKey ?? "geetorus.local-stdio-fixture",
