/**
 * PluginEventBus — typed in-process event bus for the Geetorus plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@geetorusai/shared";
import type { PluginEvent, EventFilter } from "@geetorusai/plugin-sdk";
