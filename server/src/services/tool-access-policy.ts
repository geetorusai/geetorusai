...
import { toolPolicyConditionsSchema } from "@geetorusai/shared";
...
function evaluatePolicyConditions(
  ...
  if (conditions.trustBoundary) {
    ...
    if (boolCondition(boundary.geetorusSelfOnly) === true && ctx.providerType !== "geetorus_self") {
      return conditionGroupFail("trustBoundary", "Policy condition requires a Geetorus self tool.");
    }
