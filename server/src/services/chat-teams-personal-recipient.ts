...
const recipientSchema = z
  .object({
    schema: z.literal("geetorus.teams.personal-recipient.v1"),
    ...scopeFields,
    aadObjectId: z.uuid(),
...
const bindingSchema = z
  .object({
    schema: z.literal("geetorus.teams.personal-recipient-binding.v1"),
...
// A route-free ID is Geetorus's durable identity. The pinned SDK's routed
...
export function deriveTeamsPersonalRecipient(
  ...
  return parseTeamsPersonalRecipient(
    {
      schema: "geetorus.teams.personal-recipient.v1",
...
export function bindTeamsPersonalRecipient(
  ...
  return Object.freeze({
    schema: "geetorus.teams.personal-recipient-binding.v1",
    recipient,
