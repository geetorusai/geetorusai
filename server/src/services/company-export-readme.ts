 ...
 */
import type { CompanyPortabilityManifest } from "@geetorusai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Geetorus](https://geetorus.ing)");
  lines.push("");
