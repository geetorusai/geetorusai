...
const REPO_ONLY_CWD_SENTINEL = "/__geetorus_repo_only__";
...
export function projectService(db: Db) {
  ...
  return {
      ...
      if (existingBinding) {
        ...
        if (existingProject) {
          ...
          return {
            ...
            project: project as import("@geetorusai/shared").Project | null,
        ...
        return {
          ...
          project: hydrated as import("@geetorusai/shared").Project | null,
          status: "relinked",
        };
      }
    ...
    createWithRepositories: async (companyId: string, data: Parameters<typeof createProject>[1], repositories: import("@geetorusai/shared").ProjectRepository[]): Promise<ProjectWithGoals> => {
    ...
    replaceRepositories: async (projectId: string, repositories: import("@geetorusai/shared").ProjectRepository[]): Promise<ProjectWithGoals | null> => {
      return db.transaction(async (tx) => {
