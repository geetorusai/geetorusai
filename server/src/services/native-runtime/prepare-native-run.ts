...
import { completionContracts, heartbeatRuns } from "@geetorusai/db";
  ...
  await input.db.transaction(async (tx) => {
    ...
    await tx
      ...
      .set({
        ...
        runtimeModeReason: locked.runtimeModeReason ?? "explicit_geetorus_runner",
        runtimeModeResolvedAt: locked.runtimeModeResolvedAt ?? new Date(),
        runnerProfileJson: {
          schema: "geetorus.runner.profile.v1",
          provider: "codex",
          turnId,
          itemId,
          environmentLeaseId,
