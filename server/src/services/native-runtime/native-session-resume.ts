...
import { heartbeatRunEvents, heartbeatRuns, type Db } from "@geetorusai/db";
import type {
  NativeExecutionInput,
  PersistedNativeSession,
} from "../../vendor/geetorus-runner/index.js";
import { parseNativeExecutionInput } from "../../vendor/geetorus-runner/index.js";
...
export function nativeToolContractFingerprintForTarget(
  ...
  return `sha256:${createHash("sha256")
    .update(
      JSON.stringify({
        schema: "geetorus.native-tool-contract.v13",
        executionTargetKind,
        advertisementPolicy: {
