...
import { heartbeatRunEvents } from "@geetorusai/db";
import type { HarnessRuntimeRequestKind } from "../../vendor/geetorus-runner/index.js";
...
function canonicalPendingRequest(input: {
  ...
  if (
    !event
    || event.schema !== "geetorus.prp.event.v1"
