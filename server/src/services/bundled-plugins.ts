 ...
 * `GEETORUS_MANAGED_CONFIG` (parsed fail-closed at startup — see
 ...
 */
export const BUNDLED_CATALOG_ROOT_ENV_VAR = "GEETORUS_BUNDLED_PLUGIN_ROOT";
...
export const BUNDLED_PLUGIN_CATALOG: readonly BundledPluginCatalogEntry[] = [
  {
    key: "createos",
    pluginKey: "geetorus.createos-sandbox-provider",
    relativePath: "sandbox-providers/createos",
  },
  {
    key: "cloudflare",
    pluginKey: "geetorus.cloudflare-sandbox-provider",
    relativePath: "sandbox-providers/cloudflare",
  },
  {
    key: "daytona",
    pluginKey: "geetorus.daytona-sandbox-provider",
    relativePath: "sandbox-providers/daytona",
  },
  {
    key: "e2b",
    pluginKey: "geetorus.e2b-sandbox-provider",
    relativePath: "sandbox-providers/e2b",
  },
  {
    key: "exe-dev",
    pluginKey: "geetorus.exe-dev-sandbox-provider",
  ...
  },
  {
    ...
    pathOverrideEnvVar: "GEETORUS_KUBERNETES_PLUGIN_PATH",
  },
  {
    key: "modal",
    pluginKey: "geetorus.modal-sandbox-provider",
    relativePath: "sandbox-providers/modal",
  },
  {
    key: "novita",
    pluginKey: "geetorus.novita-sandbox-provider",
...
export interface BundledPluginProvisionerDeps {
  registry: {
    ...
    update(
      id: string,
      data: { version?: string; manifest?: GeetorusPluginManifestV1 },
    ): Promise<unknown>;
