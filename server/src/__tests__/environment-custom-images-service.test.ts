...
function pluginManifest() {
  return {
    id: "geetorus.fake-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
describeEmbeddedPostgres("environmentCustomImageService", () => {
  ...
  async function seed() {
    ...
    await db.insert(plugins).values({
      pluginKey: "geetorus.fake-sandbox-provider",
      packageName: "geetorus-plugin-fake-sandbox",
      version: "0.1.0",
      apiVersion: 1,
      categories: ["automation"],
...
function secretPluginManifest() {
  return {
    id: "geetorus.fake-secret-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
function invalidIdentityPluginManifest() {
  return {
    id: "geetorus.fake-invalid-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
function prototypeKeyIdentityPluginManifest() {
  return {
    id: "geetorus.fake-prototype-key-sandbox-provider",
    apiVersion: 1,
    version: "0.1.0",
...
describeEmbeddedPostgres("environmentCustomImageService relink", () => {
  ...
  async function seed(opts?: {
    ...
    await db.insert(plugins).values({
      ...
      packageName: `geetorus-plugin-${provider}`,
      version: "0.1.0",
      apiVersion: 1,
      categories: ["automation"],
