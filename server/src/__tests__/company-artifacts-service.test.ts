...
import { ISSUE_CONTINUATION_SUMMARY_DOCUMENT_KEY } from "@geetorusai/shared";
import {
...
describeEmbeddedPostgres("companyArtifactsService", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("geetorus-company-artifacts-");
  ...
  async function seedArtifacts() {
    ...
    await db.insert(companies).values([
      { id: companyId, name: "Geetorus", issuePrefix: "PAP", requireBoardApprovalForNewAgents: false },
