...
describe("P6-16/P6-25/P6-28 native finalization recovery", () => {
  ...
  beforeAll(async () => {
    temporary = await startEmbeddedPostgresTestDatabase("geetorus-native-recovery-");
    ...
    const stalePort = new GeetorusControlPlanePort(db, {
      companyId,
      issueId: staleIssueId,
      runId: staleRunId,
      agentId,
