...
import { companies, createDb, executionWorkspaces, issues, projects } from "@geetorusai/db";
...
(support.supported ? describe : describe.skip)("runtime shared workspace binding", () => {
  ...
  beforeAll(async () => {
    temporary = await startEmbeddedPostgresTestDatabase("geetorus-runtime-workspace-binding-");
