...
import { issues } from "@geetorusai/db";
...
/**
 * Regression coverage for https://github.com/geetorusai/geetorus/issues/4628.
...
describeEmbeddedPostgres("issue list status query parsing", () => {
  const ctx = useEmbeddedPostgres("geetorus-issues-list-query-parsing-", {
