...
import { activityLog, agents, companies, createDb, heartbeatRuns, issues, projects } from "@geetorusai/db";
...
describePostgres("tasks created from an issue", () => {
  ...
  beforeAll(async () => {
    database = await startEmbeddedPostgresTestDatabase("geetorus-created-from-");
