...
import { activityLog, agents, companies, companySkillPolicies, createDb } from "@geetorusai/db";
...
describeEmbeddedPostgres("company skill policy routes", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("geetorus-skill-policy-routes-");
