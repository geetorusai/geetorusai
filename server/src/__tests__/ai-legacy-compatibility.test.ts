...
import { createDb, companies, agents, companyMemberships, adapterAuthSessions, environments, connectionGrants, toolConnections, activityLog } from "@geetorusai/db";
...
const directoryFor = (id: string) => path.join(resolveGeetorusInstanceRoot(), "ai-local-logins", id);
