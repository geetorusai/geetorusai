...
const TEST_MANIFEST: GeetorusPluginManifestV1 = {
  id: "test.plugin",
  apiVersion: 1,
  version: "1.0.0",
...
describe("plugin proactive company scope (LOOA-629)", () => {
  ...
  // those calls carry no geetorusInvocationId (the fixture's "omit" mode). The
...
const PTY_SESSION_HOME = "/tmp/geetorus-adapter-login/11111111-2222-4333-8444-555555555555";
    ...
    try {
      ...
      await expect(
        handle.openLoginPtySession({
          ...
          providerLeaseId: JSON.stringify({ mode: "normal" }),
          loginCommandKey: "claude" as const,
          sessionHome: "/tmp/geetorus-adapter-login/../etc",
        }),
