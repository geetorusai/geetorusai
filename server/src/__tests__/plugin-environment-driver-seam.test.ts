...
import { pluginManifestV1Schema, type GeetorusPluginManifestV1 } from "@geetorusai/shared";
import { pluginCapabilityValidator } from "../services/plugin-capability-validator.js";

const baseManifest: GeetorusPluginManifestV1 = {
...
describe("plugin environment driver seam", () => {
  ...
  it("enforces environment driver capability requirements", () => {
    ...
    const withoutCapability = {
      ...baseManifest,
      capabilities: ["http.outbound"],
    } satisfies GeetorusPluginManifestV1;
...
const objectReferenceManifest: GeetorusPluginManifestV1 = {
