...
import { createAgentHireSchema, createIssueThreadInteractionSchema, updateIssueSchema } from "@geetorusai/shared";
import { runnerApiReference } from "../services/native-runtime/runner-api-reference.js";

const reference = readFileSync(new URL("../../../skills/geetorus/references/api-reference.md", import.meta.url), "utf8");
