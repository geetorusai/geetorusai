...
import { buildGeetorusWakePayload, heartbeatService } from "../services/heartbeat.js";
...
describeEmbeddedPostgres("issue recovery actions", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("geetorus-issue-recovery-actions-");
