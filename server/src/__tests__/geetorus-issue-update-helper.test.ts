...
// End-to-end coverage for scripts/geetorus-issue-update.sh: the helper must
...
const HELPER_PATH = path.resolve("scripts/geetorus-issue-update.sh");
...
describe("geetorus issue update helper", () => {
    ...
    return new Promise((resolve, reject) => {
      const child = spawn("bash", [HELPER_PATH, ...args], {
        env: {
          ...
          GEETORUS_API_KEY: "test-key",
          GEETORUS_RUN_ID: "test-run",
        },
