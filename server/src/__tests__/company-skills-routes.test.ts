...
describe("company skill mutation permissions", () => {
  ...
  beforeEach(() => {
    ...
    mockCatalogService.readCatalogSkillFile.mockResolvedValue({
      catalogSkillId: "geetorusai:bundled:software-development:review",
      path: "SKILL.md",
      kind: "skill",
      content: "# Review",
      language: "markdown",
  ...
  it("allows board users with skills:create to create, import, install, update, delete, audit, and reset company skills", async () => {
    ...
    await request(app)
      ...
      .send({ catalogSkillId: "geetorusai:bundled:software-development:review" })
      .expect(201);
    await request(app)
  ...
  it("installs catalog skills with mutation permissions and logs provenance", async () => {
    ...
    expect(mockLogActivity).toHaveBeenCalledWith(expect.anything(), expect.objectContaining({
      ...
      details: expect.objectContaining({
        catalogId: "geetorusai:bundled:software-development:review",
        catalogKey: "geetorusai/bundled/software-development/review",
        originHash: "sha256:abc",
      }),
    }));
  });
