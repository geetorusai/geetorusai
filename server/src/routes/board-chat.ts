 ...
 * chat relay that spawns the `claude` CLI with the geetorus-board skill as
...
export function boardChatRoutes(
  ...
  // repo-root `skills/geetorus-board/SKILL.md` whether running from
  ...
  function loadBoardSkill(): string {
    ...
    const skillPath = path.resolve(here, "../../../skills/geetorus-board/SKILL.md");
    try {
      ...
      return (
        ...
        "company through Geetorus. Help them create companies, hire agents, " +
