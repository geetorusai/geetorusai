/**
 * Server-side SVG renderer for Geetorus org charts.
...
// Geetorus logo: scaled icon (~16px) + wordmark (13px), vertically centered
const GEETORUS_LOGO_SVG = `<g>
  <g transform="scale(0.72)" transform-origin="0 0">
    <circle cx="12" cy="12" r="7.5" stroke="currentColor" stroke-width="4.25" fill="none" />
  </g>
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Geetorus</text>
</g>`;
