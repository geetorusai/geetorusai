 ...
 */
type RunnerTestingModule = typeof import("@geetorusai/geetorus-runner/testing");
...
} from "@geetorusai/geetorus-runner/testing";

const sourceUrl = new URL(
  "../../../../packages/geetorus-runner/src/testing.ts",
  import.meta.url,
);
