...
interface IncomingMessageWithTerminalContext extends IncomingMessage {
  ...
  geetorusTerminalUpgradeContext?: TerminalUpgradeContext;
}
...
export function setupEnvironmentCustomImageTerminalWebSocketServer(
  ...
  wss.on("connection", (socket: TerminalWsSocket, req: IncomingMessage) => {
    const upgradeContext = (req as IncomingMessageWithTerminalContext).geetorusTerminalUpgradeContext;
    if (!upgradeContext) {
  ...
  server.on("upgrade", (req, socket, head) => {
    ...
    reqWithContext.geetorusWebSocketHandled = true;
    ...
    reqWithContext.geetorusTerminalUpgradeContext = {
