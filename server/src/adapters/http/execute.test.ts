...
describe("http adapter execute", () => {
  it("delivers the complete runtime connection descriptor and shared guidance", async () => {
    ...
    guardedFetchMock.mockImplementation(async (_url: string, init?: RequestInit) => {
      ...
      expect(body.geetorusRuntimeTools).toEqual({
        version: 1,
        guidance: CONNECTION_INTENT_AGENT_GUIDANCE,
        mcpEndpoint: "https://geetorus.test/mcp/runtime-tools",
        rest: {
          connectionsSearch: "https://geetorus.test/runtime-tools/connections/search",
          connectionRequest: "https://geetorus.test/runtime-tools/connections/request",
        },
