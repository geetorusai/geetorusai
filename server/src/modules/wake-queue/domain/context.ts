...
const GEETORUS_WAKE_PAYLOAD_KEY = "geetorusWake";
const GEETORUS_WAKE_COMMENT_KEY = "geetorusWakeComment";
const GEETORUS_TASK_MARKDOWN_KEY = "geetorusTaskMarkdown";
const GEETORUS_TASK_MARKDOWN_COMPACT_KEY = "geetorusTaskMarkdownCompact";
...
export function enrichPromotedWakeContext(
  ...
  delete contextSnapshot[GEETORUS_WAKE_PAYLOAD_KEY];
  delete contextSnapshot[GEETORUS_WAKE_COMMENT_KEY];
  delete contextSnapshot[GEETORUS_TASK_MARKDOWN_KEY];
  delete contextSnapshot[GEETORUS_TASK_MARKDOWN_COMPACT_KEY];
