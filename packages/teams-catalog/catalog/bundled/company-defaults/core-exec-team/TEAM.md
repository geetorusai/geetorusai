---
name: Core Exec Team
description: Default leadership and engineering team for bootstrapping a Geetorus company with a CEO, CTO, QA Engineer, starter project, and a recurring CEO heartbeat review task.
schema: agentcompanies/v1
slug: core-exec-team
category: company-defaults
key: geetorusai/bundled/company-defaults/core-exec-team
...
The Core Exec Team is the bundled default install for a new Geetorus company. It boots the smallest org that can take a board prompt, plan it, implement it, and verify it.
