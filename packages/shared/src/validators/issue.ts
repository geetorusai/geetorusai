...
const geetorusQuestionOptionSchema = z.object({
...
const geetorusQuestionSchema = z
  .object({
    id: z.string().min(1).max(160),
    ...
    options: z.array(geetorusQuestionOptionSchema).max(128).optional(),
    customAnswer: z
      .object({
...
export const geetorusQuestionSetPayloadSchema = z
  .object({
    schema: z.literal("geetorus.question_set.v1"),
    title: z.string().max(1000).optional(),
    description: z.string().max(4000).optional(),
    submitLabel: z.string().max(200).optional(),
    questions: z.array(geetorusQuestionSchema).min(1).max(64),
  })
  .superRefine((value, ctx) => {
...
export const askUserQuestionsPayloadSchema = z
  .object({
    ...
    questionSet: geetorusQuestionSetPayloadSchema.optional(),
