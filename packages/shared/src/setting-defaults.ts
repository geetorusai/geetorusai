 ...
 * `GEETORUS_SETTING_DEFAULTS` environment variable to a JSON object, e.g.
 ...
 * with `GEETORUS_HIDDEN_SETTINGS` (see settings-visibility.ts); the two
 * mechanisms are orthogonal.
 */

export const SETTING_DEFAULTS_ENV_KEY = "GEETORUS_SETTING_DEFAULTS";
...
/**
 * Parse a `GEETORUS_SETTING_DEFAULTS`-style JSON object.
 *
