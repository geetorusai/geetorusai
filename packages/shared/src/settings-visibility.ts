 ...
 * `GEETORUS_HIDDEN_SETTINGS` environment variable to a comma-separated
...
/** Every key `GEETORUS_HIDDEN_SETTINGS` accepts. */
...
/** Parse a `GEETORUS_HIDDEN_SETTINGS`-style comma-separated list. */
