...
export const NODE_VERSION_INSTALL_GUIDE_URL =
  "https://github.com/geetorusai/geetorus/blob/master/doc/INSTALLING.md#recommended-install";
const NODE_VERSION_WARNING_EMITTED = Symbol.for("@geetorusai/node-version-warning-emitted");
...
export function formatNodeVersionWarning(version: string): string | null {
  ...
  return [
    `[geetorus] warning: Node.js ${currentVersion} is unsupported. Geetorus requires Node.js ${MINIMUM_NODE_VERSION} or newer.`,
    ...
    "Restart Geetorus after upgrading.",
