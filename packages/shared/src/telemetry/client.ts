...
import { GEETORUS_EVENTS } from "./generated/geetorus-telemetry.js";

const DEFAULT_ENDPOINTS = [
  "https://telemetry.geetorus.ing/ingest",
...
export class TelemetryClient {
  ...
  /**
   * Tracks first-party Geetorus telemetry events registered in the generated
   * backend event schema.
   */
  track<K extends TelemetryEventName>(eventName: K, ...args: TrackArgs<K>): void {
    if (!Object.hasOwn(GEETORUS_EVENTS, eventName)) return;
