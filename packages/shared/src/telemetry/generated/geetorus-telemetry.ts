...
export interface GeetorusAgentCreatedDimensions {
agent_id: string
agent_role: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
}

export interface GeetorusAgentFirstHeartbeatDimensions {
agent_id: string
agent_role: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
}

export interface GeetorusAgentTaskCompletedDimensions {
...
export interface GeetorusAgentTaskRunDimensions {
adapter_type?: ("process" | "http" | "acpx_local" | "claude_local" | "codex_local" | "cursor_cloud" | "gemini_local" | "hermes_gateway" | "hermes_local" | "opencode_local" | "pi_local" | "cursor" | "openclaw_gateway" | "grok_local" | "kimi_local" | "other")
agent_id: string
agent_role?: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
model?: string
...
export interface GeetorusCompanyImportedDimensions {
source_type: ("local_path" | "github" | "url" | "catalog" | "skills_sh" | "unknown")
source_ref?: string
source_ref_hashed?: boolean
}

export interface GeetorusErrorHandlerCrashDimensions {
error_code: string
}

export interface GeetorusGoalCreatedDimensions {
goal_level: ("company" | "team" | "agent" | "task" | "other")
}

export interface GeetorusInstallCompletedDimensions {
adapter_type: ("process" | "http" | "acpx_local" | "claude_local" | "codex_local" | "cursor_cloud" | "gemini_local" | "hermes_gateway" | "hermes_local" | "opencode_local" | "pi_local" | "cursor" | "openclaw_gateway" | "grok_local" | "kimi_local" | "other")
}

export interface GeetorusInstallStartedDimensions {

}

export interface GeetorusInteractionCreatedDimensions {
...
export interface GeetorusInteractionResolvedDimensions {
interaction_kind: ("suggest_tasks" | "ask_user_questions" | "request_confirmation" | "request_checkbox_confirmation" | "request_item_verdicts" | "other")
...
export interface GeetorusProjectCreatedDimensions {

}

export interface GeetorusRoutineCreatedDimensions {

}

export interface GeetorusRoutineRunDimensions {
source: ("schedule" | "manual" | "api" | "webhook" | "other")
status: ("received" | "coalesced" | "skipped" | "issue_created" | "completed" | "failed" | "other")
}

export interface GeetorusSkillImportedDimensions {
source_type: ("local_path" | "github" | "url" | "catalog" | "skills_sh" | "unknown")
skill_ref?: string
}

export type GeetorusEventName =
  | "agent.created"
...
export interface EventDimensionsMap {
  "agent.created": GeetorusAgentCreatedDimensions;
  "agent.first_heartbeat": GeetorusAgentFirstHeartbeatDimensions;
  "agent.task_completed": GeetorusAgentTaskCompletedDimensions;
  "agent.task_run": GeetorusAgentTaskRunDimensions;
  "company.imported": GeetorusCompanyImportedDimensions;
  "error.handler_crash": GeetorusErrorHandlerCrashDimensions;
  "goal.created": GeetorusGoalCreatedDimensions;
  "install.completed": GeetorusInstallCompletedDimensions;
  "install.started": GeetorusInstallStartedDimensions;
  "interaction.created": GeetorusInteractionCreatedDimensions;
  "interaction.resolved": GeetorusInteractionResolvedDimensions;
  "project.created": GeetorusProjectCreatedDimensions;
  "routine.created": GeetorusRoutineCreatedDimensions;
  "routine.run": GeetorusRoutineRunDimensions;
  "skill.imported": GeetorusSkillImportedDimensions;
}

export const GEETORUS_EVENTS = {
...
export const GEETORUS_ENUM_DESCRIPTIONS = {
  "agent.created": {
    "agent_role": {
  ...
  "company.imported": {
    "source_type": {
      ...
      "catalog": "Import source came from a Geetorus catalog entry.",
  ...
  "interaction.resolved": {
    ...
    "resolved_by_kind": {
      ...
      "system": "Geetorus resolved the interaction automatically.",
...
export interface GeetorusTelemetryEvent<K extends GeetorusEventName = GeetorusEventName> {
name: K
occurredAt: string
dimensions: EventDimensionsMap[K]
}

export type AnyGeetorusTelemetryEvent = {
  [K in GeetorusEventName]: GeetorusTelemetryEvent<K>
}[GeetorusEventName];

export interface GeetorusTelemetryBatch {
app: "geetorus"
schemaVersion: typeof SCHEMA_VERSION
installId: string
/**
 * Optional client application build version. Geetorus clients report PEP 440
 ...
 */
version?: string
events: AnyGeetorusTelemetryEvent[]
}

export function makeEvent<K extends GeetorusEventName>(
  name: K,
  dimensions: EventDimensionsMap[K],
  occurredAt: string
): GeetorusTelemetryEvent<K> {
  return { name, occurredAt, dimensions };
}

export function makeBatch(
  installId: string,
  events: readonly AnyGeetorusTelemetryEvent[],
  /**
   * Optional client application build version. Geetorus clients report PEP 440
   * local versions such as <nearest-tag>+<commits-since-tag>.git.<abbrev-sha>;
   * nearest tags are usually CalVer, but legacy SemVer tags such as 0.3.1 can
