 ...
 *
 * Defines the retention class for each Geetorus telemetry event and the
 ...
 * that are not part of the shared generated `GeetorusEventName` type. When an
 ...
 *   External-system event (Codex CLI) — not yet in GeetorusEventName.
