...
import * as generatedTelemetry from "./generated/geetorus-telemetry.js";
...
describe("telemetry README contract", () => {
  it("documents generated event helper exports that exist", () => {
    ...
    expect(readme).not.toContain("createGeetorusTelemetryEvent");
    expect(readme).not.toContain("createGeetorusTelemetryEnvelope");
  });
});
