...
// Config keys owned by Geetorus/company state rather than one concrete adapter.
// `geetorusSkillSync` is persisted in adapterConfig but must survive adapter swaps.
...
export const SECRET_MANAGED_MODES = ["geetorus_managed", "external_reference"] as const;
...
export const TOOL_APPLICATION_TYPES = ["mcp_http", "mcp_stdio", "geetorus_plugin", "a2a", "chat"] as const;
 ...
 * Geetorus UI where plugin components can be rendered.
 *
