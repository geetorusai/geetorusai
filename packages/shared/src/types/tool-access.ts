...
/**
 * How Geetorus obtained the OAuth client it will use for a connection
...
/**
 * What an unknown remote MCP endpoint told Geetorus it needs, so the wizard can
...
export interface ToolOAuthStartResult {
  ...
  expiresAt: string;
  /**
   * Opaque Geetorus Cloud authorization handoff. The board submits this only
