...
export interface InstanceExperimentalSettings {
  ...
  /**
   * Exposes the experimental Geetorus Runner adapter for new selections.
  ...
  /** Shows internal Geetorus maintainer tools and observability links. */
  enableGeetorusDeveloperMode: boolean;
  /**
  ...
  /**
   * Worktree preview instances (`GEETORUS_IN_WORKTREE=true`) suppress the
