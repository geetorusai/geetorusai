...
const runnerRequire = createRequire(new URL("../../geetorus-runner/package.json", import.meta.url));
...
// a runtime dependency on a Geetorus workspace package.
...
const target = new URL("../../geetorus-runner/src/mock-core/skill-frontmatter.generated.ts", import.meta.url);
