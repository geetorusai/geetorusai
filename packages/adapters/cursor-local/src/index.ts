...
Use when:
- You want Geetorus to run Cursor Agent CLI locally as the agent runtime
...
- Geetorus auto-injects local skills into "~/.cursor/skills" when missing, so Cursor can discover "$geetorus" and related skills on local runs.
- Geetorus auto-adds --yolo unless one of --trust/--yolo/-f is already present in extraArgs.
