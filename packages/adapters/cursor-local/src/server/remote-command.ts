...
import { ensurePathInEnv } from "@geetorusai/adapter-utils/server-utils";
...
async function readSandboxCursorRuntimeInfo(input: {
  ...
  const homeMarker = "__GEETORUS_CURSOR_HOME__:";
  const preferredMarker = "__GEETORUS_CURSOR_AGENT__:";
  try {
