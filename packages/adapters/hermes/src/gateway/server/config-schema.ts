  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        hint: "Hermes API_SERVER_KEY, not GEETORUS_API_KEY. Stored as a Geetorus secret reference.",
        meta: { secret: true },
      },
      {
      ...
      },
      {
        ...
        type: "text",
        hint: "Optional Geetorus API URL reachable by the remote Hermes host. This is not a credential.",
      },
      {
        key: "headers",
        label: "Extra headers",
