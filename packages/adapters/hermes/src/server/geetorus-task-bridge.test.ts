...
const helperPath = path.resolve(__dirname, "../../skills/geetorus-task-bridge/geetorus-task.mjs");
...
describe("geetorus-task-bridge helper", () => {
  ...
  function env() {
    return {
      GEETORUS_API_URL: baseUrl,
      GEETORUS_BRIDGE_API_KEY: apiKey,
      GEETORUS_COMPANY_ID: "22222222-2222-4222-8222-222222222222",
      GEETORUS_AGENT_ID: "11111111-1111-4111-8111-111111111111",
      GEETORUS_RUN_ID: "66666666-6666-4666-8666-666666666666",
    };
  }
  ...
  it("creates tasks assigned to the authenticated agent by default", async () => {
    ...
    expect(createRequest?.headers["x-geetorus-run-id"]).toBe("66666666-6666-4666-8666-666666666666");
