import type { AdapterConfigSchema } from "@geetorusai/adapter-utils";
  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Resume Hermes sessions across Geetorus heartbeats.",
      },
      {
        key: "worktreeMode",
      ...
      },
      {
        ...
        type: "toggle",
        default: true,
        hint: "Pass Hermes --quiet for cleaner Geetorus run transcripts.",
      },
      {
        key: "verbose",
      ...
      },
      {
        ...
        type: "text",
        hint: "Optional API base override. Defaults to GEETORUS_API_URL.",
      },
      {
        key: "promptTemplate",
