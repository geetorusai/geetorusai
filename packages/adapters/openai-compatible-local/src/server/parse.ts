import { asNumber, asString, parseJson, parseObject } from "@geetorusai/adapter-utils/server-utils";
...
export function parseOpenAICompatibleJsonl(stdout: string) {
...
export function isOpenAICompatibleUnknownSessionError(stdout: string, stderr: string): boolean {
