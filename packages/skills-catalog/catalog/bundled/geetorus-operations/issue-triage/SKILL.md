---
name: issue-triage
description: Triage Geetorus inbox issues that are stale, blocked, in-review, or assigned-but-not-progressing, and decide a single next action per issue (resume, reassign, unblock, escalate, or close).
key: geetorusai/bundled/geetorus-operations/issue-triage
recommendedForRoles:
  - manager
  - ceo
  - engineer
