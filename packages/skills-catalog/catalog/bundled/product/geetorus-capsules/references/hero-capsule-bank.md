...
The hero capsule bank is the one approved decorative exception to the rule that capsules represent individual agents. It is a canonical Geetorus brand surface. Do not improvise a different capsule bank.

## Source Precedence

1. `geetorus-content/td/capsules.md` - byte-accurate technical source for geometry, gradients, grain, crop, and wave.
2. Geetorus feature-video HyperFrames skill:
   - `references/capsule-bank-spec.md`
   - `references/brand-tokens.md`
   - `references/composition-recipes.md`
3. `geetorus-content/videos/wireframe-skill-launch/src/HeroCapsuleBank.tsx` - working Remotion implementation.
