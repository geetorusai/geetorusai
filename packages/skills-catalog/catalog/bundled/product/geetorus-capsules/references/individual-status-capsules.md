...
5. Website brand guide files under `geetorus-website/src/components/brand/sections/*` - marketing rules and the 12-preset website palette.
...
Do not treat these as the universal Geetorus capsule palette. The website brand guide exposes 12 presets, the video references have a separate 12-gradient palette, and the hero bank has 45 gradients.
