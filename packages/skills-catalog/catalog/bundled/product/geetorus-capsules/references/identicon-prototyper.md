...
Use this reference when generating or reviewing deterministic Geetorus capsule identicons/profile pills. Prototype source paths, when the Geetorus content repository is available:

- `geetorus-content/design/PAP-11825/geetorus-capsule-identicon-prototyper/README.md`
- `geetorus-content/design/PAP-11825/geetorus-capsule-identicon-prototyper/src/identicon.ts`
- `geetorus-content/design/PAP-11825/geetorus-capsule-identicon-prototyper/src/App.tsx`
