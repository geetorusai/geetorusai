...
key: geetorusai/optional/content/release-announcement
recommendedForRoles:
  - devrel
  - product
  - writer
...
## Geetorus Cases output

When this skill runs inside Geetorus and `experimental.enableCases` is enabled,
...
Use `skills/geetorus/references/cases.md` for the API contract. Include
`X-Geetorus-Run-Id` on writes when `GEETORUS_RUN_ID` is set. If the API returns
...
{
  "caseType": "release",
  "key": "geetorus-release:vYYYY.MDD.P",
  "title": "Geetorus vYYYY.MDD.P release",
  "status": "in_progress",
  "fields": {
    "schema_version": 1,
    "version": "vYYYY.MDD.P",
...
{
  "caseType": "blog_post",
  "key": "geetorus-release:vYYYY.MDD.P:blog-post",
  "title": "Geetorus vYYYY.MDD.P launch post",
  "status": "in_review",
  "parentCaseId": "<release-case-id>",
  "fields": {
    "schema_version": 1,
    "version": "vYYYY.MDD.P",
    "slug": "geetorus-vYYYY-MDD-P",
...
```json
{
  ...
  "key": "geetorus-release:vYYYY.MDD.P:tweet-storm",
  "title": "Geetorus vYYYY.MDD.P tweet storm",
  "status": "in_review",
  "parentCaseId": "<release-case-id>",
  "fields": {
    "schema_version": 1,
