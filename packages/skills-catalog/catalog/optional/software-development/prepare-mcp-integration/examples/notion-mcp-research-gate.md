...
> Research Notion's hosted MCP server and prepare it for Geetorus. Start from
> the vendor documentation URL. Do not build the connector until I approve the
> research.

## Application

1. Read the current `geetorus-content/integrations/README.md` and integration
...
4. Open a research-only `geetorus-content` PR containing the planning package
...
6. Stop with the issue in review. No Geetorus App branch exists yet.

## Gate Output

```text
Research PR: https://github.com/geetorusai/geetorus-content/pull/123
...
After acceptance, create one isolated Geetorus App worktree and PR for
