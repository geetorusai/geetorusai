...
import { copyTextToClipboard, usePluginData, usePluginToast } from "@geetorusai/plugin-sdk/ui";
...
const FILE_SIDEBAR_WIDTH_STORAGE_KEY = "geetorus.workspace-diff.files-sidebar-width";
