...
const manifest: GeetorusPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Geetorus plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Geetorus",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Geetorus domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
