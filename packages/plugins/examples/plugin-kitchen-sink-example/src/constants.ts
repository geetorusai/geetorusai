import type { PluginLauncherRegistration } from "@geetorusai/plugin-sdk";

export const PLUGIN_ID = "geetorus-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".geetorus-kitchen-sink-demo.txt",
} as const;
