/**
 * `definePlugin` — the top-level helper for authoring a Geetorus plugin.
 *
...
export interface PluginDefinition {
  ...
  /**
   * Called when Geetorus scans issue/comment/document content and asks this
  ...
  /**
   * Called when Geetorus needs the current normalized status for one external
...
// ---------------------------------------------------------------------------
// GeetorusPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface GeetorusPlugin {
 ...
 * @returns A sealed `GeetorusPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@geetorusai/plugin-sdk";
