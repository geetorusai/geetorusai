/**
 * `@geetorusai/plugin-sdk/ui` — Geetorus plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@geetorusai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@geetorusai/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate Geetorus-internal links through the host router
