/**
 * Geetorus plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@geetorusai/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed Geetorus navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a Geetorus-internal path using the active company prefix.
   *
