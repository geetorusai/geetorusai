/**
 * Bundling presets for Geetorus plugins.
 *
 ...
 * to match the Geetorus plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@geetorusai/plugin-sdk/ui",
    "@geetorusai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const esbuildManifest: EsbuildLikeOptions = {
    ...
    target: "node24",
    sourcemap,
    external: ["@geetorusai/plugin-sdk"],
  };
