...
const PLUGIN_ID = "geetorus.fake-sandbox-provider";
...
const manifest: GeetorusPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Geetorus provider-plugin integration without external infrastructure.",
  author: "Geetorus",
