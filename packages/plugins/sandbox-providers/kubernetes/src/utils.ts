...
// Namespace names are capped at 63 chars (RFC 1123). The default "geetorus-"
...
export function geetorusLabels(input: LabelsInput): Record<string, string> {
  return {
    "geetorus.io/run-id": input.runId,
    "geetorus.io/agent-id": input.agentId,
    "geetorus.io/company-id": input.companyId,
    "geetorus.io/adapter": input.adapterType,
