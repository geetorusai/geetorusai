 ...
 * which geetorus-server can exec arbitrary commands. This solves the
 ...
 *
 * NOTE: geetorus-server runs OUTSIDE the cluster, so we cannot set ownerReferences
...
export function buildSandboxCrManifest(
  ...
  return {
    ...
    metadata: {
      ...
      labels: { ...input.labels },
      // No ownerReferences: geetorus-server is out-of-cluster. Release is
      // explicit delete.
    },
    spec: {
      podTemplate: {
        ...
        spec: {
          ...
          // Agent containers call back to geetorus-server via HTTPS egress;
          ...
          containers: [
            {
              ...
              // sleep infinity keeps the pod running; geetorus-server execs
              ...
              env: [{ name: "HOME", value: "/home/geetorus" }],
              ...
              volumeMounts: [
                ...
                { name: "home", mountPath: "/home/geetorus" },
                { name: "cache", mountPath: "/home/geetorus/.cache" },
