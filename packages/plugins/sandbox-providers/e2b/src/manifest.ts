...
const PLUGIN_ID = "geetorus.e2b-sandbox-provider";
...
const manifest: GeetorusPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions E2B cloud sandboxes as Geetorus execution environments.",
  author: "Geetorus",
      ...
      configSchema: {
        ...
        properties: {
          ...
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific E2B API key. Paste a key or an existing Geetorus secret reference; saved environments store pasted values as company secrets. Falls back to E2B_API_KEY if omitted.",
          },
          timeoutMs: {
            type: "number",
            description:
