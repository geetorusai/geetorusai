...
const PLUGIN_ID = "geetorus.modal-sandbox-provider";
...
const manifest: GeetorusPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions Modal sandboxes as Geetorus execution environments.",
  author: "Geetorus",
      ...
      configSchema: {
        ...
        properties: {
          ...
          tokenId: {
            ...
            format: "secret-ref",
            description:
              "Modal token ID. Paste a token or an existing Geetorus secret reference; saved environments store pasted values as company secrets. Required.",
          },
          tokenSecret: {
            type: "string",
            format: "secret-ref",
