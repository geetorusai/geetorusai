...
const PLUGIN_ID = "geetorus.novita-sandbox-provider";
...
const manifest: GeetorusPluginManifestV1 = {
  ...
  description:
    "Sandbox provider plugin that provisions Novita Agent Sandbox environments for Geetorus agent runs.",
  author: "Novita AI",
      ...
      configSchema: {
        ...
        properties: {
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific Novita API key. Paste a key or an existing Geetorus secret reference; saved environments store pasted values as company secrets. Falls back to NOVITA_API_KEY if omitted.",
          },
          domain: {
            type: "string",
            description:
          ...
          requestedCwd: {
            type: "string",
            default: "/home/user/geetorus-workspace",
          ...
          reuseLease: {
            ...
            default: false,
            description:
              "Pause and later resume the sandbox across Geetorus runs instead of killing it on release.",
          },
        },
      },
    },
