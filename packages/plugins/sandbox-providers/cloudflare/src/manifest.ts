...
const PLUGIN_ID = "geetorus.cloudflare-sandbox-provider";
  ...
  environmentDrivers: [
    {
      ...
      description:
        "Runs Geetorus sandbox environments through a Cloudflare Worker bridge backed by the Sandbox SDK and Durable Objects.",
      configSchema: {
        type: "object",
        properties: {
          bridgeBaseUrl: {
