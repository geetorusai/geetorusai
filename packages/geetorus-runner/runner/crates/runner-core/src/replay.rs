...
const PRP_FIXTURE_SCHEMA: &str = "geetorus.prp.fixture.v1";
const PRP_EVENT_SCHEMA: &str = "geetorus.prp.event.v1";
const PRP_SEMANTIC_TOOL_SCHEMA: &str = "geetorus.prp.semantic_tool.v1";
const PRP_STOP_REASON_SCHEMA: &str = "geetorus.prp.stop_reason.v1";
const PRP_SEMANTIC_TOOLS_CAPABILITY_SCHEMA: &str = "geetorus.prp.semantic_tools.v1";
