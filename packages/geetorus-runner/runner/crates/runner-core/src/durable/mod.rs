...
pub const PROTOCOL: &str = "geetorus.runner";
pub const PROTOCOL_MIN_VERSION: u64 = 1;
pub const PROTOCOL_VERSION: u64 = 2;
pub const BOOTSTRAP_TICKET_ENV: &str = "GEETORUS_RUNNER_BOOTSTRAP_TICKET";
...
impl AcpxLaunchProfile {
    pub fn canonical_digest(&self) -> Result<String, DurableRunnerError> {
        ...
        update(&mut digest, b"geetorus.runner.acpx-launch-profile.v1");
