...
pub const CONFORMANCE_FIXTURE_SCHEMA: &str = "geetorus.runner.conformance.fixture.v1";
pub const CONFORMANCE_OUTPUT_SCHEMA: &str = "geetorus.runner.conformance.output.v1";
