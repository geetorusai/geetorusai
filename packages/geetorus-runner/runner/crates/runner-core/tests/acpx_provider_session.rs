...
use geetorus_runner_core::generated_acpx_sidecar_contract::GeneratedAcpxSidecarCommand as GoalCommand;
...
fn rejects_non_utf8_directories_before_spawning() {
    ...
    let mut directory_name =
        format!("geetorus-acpx-non-utf8-{}-", std::process::id()).into_bytes();
