...
use geetorus_runner_core::generated_acpx_sidecar_contract::GeneratedAcpxSidecarEventType;
...
fn decodes_every_admitted_runtime_event_shape() {
    ...
    let cases = [
        ...
        (
            json!({"type": "semantic_result", "callId": "call-1", "operationId": "geetorus_finish", "ok": true, "result": {"ok": true}}),
...
fn validates_question_sets_and_rejects_duplicate_question_ids() {
    ...
    let valid = decode_acpx_event(
        ...
        &event(
            ...
            json!({
                "requestId": "input-1",
                "questionSet": {"schema": "geetorus.question_set.v1", "questions": [question.clone()]},
    ...
    let duplicate = event(
        ...
        json!({
            "requestId": "input-2",
            "questionSet": {"schema": "geetorus.question_set.v1", "questions": [question.clone(), question]},
        }),
    );
