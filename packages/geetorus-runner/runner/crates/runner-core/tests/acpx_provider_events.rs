use geetorus_runner_core::acpx_event_payload::{
    decode_acpx_event, AcpxEventPayload, AcpxRuntimeEventKind,
};
use geetorus_runner_core::acpx_event_scope::AcpxEventScope;
use geetorus_runner_core::acpx_sidecar_transport::AcpxSidecarEvent;
use geetorus_runner_core::durable::EventPriority;
use geetorus_runner_core::generated_acpx_sidecar_contract::{
    classify_generated_acpx_tool_operation, GeneratedAcpxSidecarEventType,
};
use geetorus_runner_core::provider_events::normalize_acpx_runtime_event;
use serde_json::json;

fn normalize(
    kind: AcpxRuntimeEventKind,
    payload: serde_json::Value,
) -> Vec<geetorus_runner_core::provider_events::NormalizedProviderEvent> {
    ...
    for payload in [
        json!({
            ...
            "locations":[{
                ...
                "pathAttestation":"geetorus.workspace_create_target.v1"
            }]
        }),
        json!({
            "type":"tool_call",
