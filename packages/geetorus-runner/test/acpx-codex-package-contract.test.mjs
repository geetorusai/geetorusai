...
test("the package exposes only the reviewed runner CLI binaries", () => {
  assert.deepEqual(runnerPackage.bin, {
    "geetorus-runner-eval-session": "./dist/cli/eval-session.js",
    "geetorus-runner-codex-proxy": "./dist/cli/codex-app-server-unix-proxy.js",
    "geetorus-runner-acpx-sidecar": "./dist/cli/acpx-runtime-sidecar.js",
    "geetorus-runner-opencode-proxy":
...
test("the Codex patch enforces isolated instructions, tools, and skills", () => {
  for (const token of [
    "GEETORUS_ACPX_ISOLATED_CONTEXT",
    "baseInstructions",
