...
export const callApiAction = {
  ...
  "canonical": {
    ...
    "realServiceBinding": "GeetorusRunnerToolAuthority",
  ...
  "documentation": {
    "title": "Call the Geetorus API",
    "description": "Fallback only: call a discovered Geetorus API operation when dedicated tools lack the required operation or parameters. Uses your existing permissions. Prefer dedicated tools; never bypass a denial or runner lifecycle tool.",
