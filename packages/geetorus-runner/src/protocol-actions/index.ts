...
export const GEETORUS_PROTOCOL_ACTIONS = deepFreezeProtocolAction([
  createSkillAction,
  createProjectAction,
...
export function geetorusProtocolAction(operationId: string) {
  return GEETORUS_PROTOCOL_ACTIONS.find((action) => action.id === operationId);
}
