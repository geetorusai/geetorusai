...
export const searchApiAction = {
  ...
  "documentation": {
    "title": "Search the Geetorus API",
    "description": "Fallback only: discover Geetorus API operations when the available dedicated tools cannot express the task. Prefer dedicated tools for common operations; do not search before using them.",
