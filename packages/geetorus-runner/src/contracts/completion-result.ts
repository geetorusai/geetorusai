...
export const PRP_COMPLETION_TOOL_NAME = "geetorus_finish" as const;
export const PRP_BLOCK_TOOL_NAME = "geetorus_block" as const;
...
const commonResultProperties = {
  schema: { type: "string", const: "geetorus.run_result.v1" },
  summary: {
    type: "string",
    minLength: 1,
    description:
