...
export const NATIVE_EXECUTION_INPUT_SCHEMA_V1 = "geetorus.native-execution-input.v1" as const;
export const NATIVE_EXECUTION_INPUT_SCHEMA_V2 = "geetorus.native-execution-input.v2" as const;
export const NATIVE_EXECUTION_INPUT_SCHEMA_V3 = "geetorus.native-execution-input.v3" as const;
export const NATIVE_EXECUTION_INPUT_SCHEMA = "geetorus.native-execution-input.v4" as const;
export const NATIVE_MODEL_ENVELOPE_SCHEMA_V1 = "geetorus.native-model-envelope.v1" as const;
export const NATIVE_MODEL_ENVELOPE_SCHEMA = "geetorus.native-model-envelope.v2" as const;
...
export interface NativeModelEnvelopeV1 {
  ...
  /** Remote providers have no Geetorus workspace mounted in their service. */
...
/**
 * Strictly validates the closed Geetorus-to-runner launch contract. This is
