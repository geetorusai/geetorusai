...
describe("provider notification authority", () => {
  it.each([
    ...
    ["geetorus/canonicalProviderEvent", { threadId: null, eventType: "provider.notice.recorded" }, "root"],
    ["geetorus/canonicalProviderEvent", { threadId: null, eventType: "tool.execution.started" }, "invalid_authority"],
    ...
    ["geetorus/runResult", { threadId: "child" }, "invalid_authority"],
