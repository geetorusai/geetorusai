import type { HarnessRuntimeRequest, GeetorusQuestionSet } from "../../contracts/harness-driver.js";
import {
...
export async function handleServerRequest(
  state: CodexSessionState,
    ...
    try {
      ...
      const correlation = request.geetorusTrace;
...
async function handleServerRequestBody(
  state: CodexSessionState,
          ...
          contentItems: [
            {
              ...
              text:
                tool === CODEX_BLOCK_TOOL_NAME
                  ? "geetorus_block requires reportedWorkDisposition=blocked."
                  : "geetorus_finish accepts done, needs_review, or yielded with a response_wake continuation.",
            },
          ],
        };
      }
    ...
    let input: GeetorusQuestionSet | null = null;
