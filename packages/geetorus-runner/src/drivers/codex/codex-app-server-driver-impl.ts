...
export class CodexAppServerDriver implements HarnessDriver {
  ...
  #transport(context?: {
    ...
    const workingDirectory = context?.workingDirectory ?? this.#options.environment?.GEETORUS_WORKSPACE_CWD;
    ...
    return {
      ...
      context: {
        ...
        sandbox: {
          ...
          githubAuthenticationMode: this.#options.environment?.GEETORUS_GITHUB_AUTH_MODE ?? "managed",
        },
