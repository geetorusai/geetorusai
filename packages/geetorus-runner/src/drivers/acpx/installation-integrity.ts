...
const VERIFIED_PROVIDER_RUNTIME_TARGET_ENV =
  "GEETORUS_ACPX_VERIFIED_PROVIDER_RUNTIME_TARGET";
...
function defaultPackageJsonResolver(
  ...
  const providerPackageRoot = process.env.GEETORUS_ACPX_PROVIDER_PACKAGE_ROOT;
  if (providerPackageRoot !== undefined) {
    return createAcpxPackageJsonResolver(
      providerPackageRoot,
      process.env.GEETORUS_ACPX_PROVIDER_PACKAGE_MANIFEST,
