...
const SECURE_CAPABILITY_COOKIE = "__Host-geetorus_scenario-chat";
const TAILNET_HTTP_CAPABILITY_COOKIE = "geetorus_scenario-chat";

const FORBIDDEN_ENV_NAME = /^(?:GEETORUS_|GITHUB_|AWS_|GOOGLE_|AZURE_)|(?:API_KEY|TOKEN|SECRET|PASSWORD|DATABASE_URL|CODEX_HOME)$/i;
