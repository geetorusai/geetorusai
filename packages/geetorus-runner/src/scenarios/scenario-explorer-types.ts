...
export interface CapabilityScenarioIndex {
  schema: "geetorus.capability.scenario-index.v1";
...
export interface CapabilityExposure {
  schema: "geetorus.capability.exposure.v1";
...
export interface CapabilityStateDiff {
  schema: "geetorus.capability.state-diff.v1";
...
export interface CapabilityParityReport {
  schema: "geetorus.capability.scenario-parity.v1";
...
export interface CapabilityRunArtifact {
  schema: "geetorus.capability.run-artifact.v1";
  scenarioId: string;
