 ...
 */
export const EVAL_BUNDLE_SCHEMA = "geetorus.runner.eval-bundle.v1" as const;
export const EVAL_BUNDLE_EVIDENCE_SCHEMA =
  "geetorus.runner.eval-bundle-evidence.v1" as const;
...
export interface EvalBundleRunner {
  /** Runner package, e.g. `@geetorusai/geetorus-runner`. */
  package: string;
  /** Runner binary that hosts the provider session, e.g. `geetorus-runnerd`. */
  binary: string;
  version: string;
}
