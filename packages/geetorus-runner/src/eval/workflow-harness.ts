import { runGeetorusEvalMatrix, type GeetorusEvalCandidate } from "@geetorusai/geetorus-eval-kernel";
...
export const DETERMINISTIC_RUNNER_WORKFLOW_CANDIDATES: readonly GeetorusEvalCandidate<DeterministicRunnerWorkflowCandidate>[] = Object.freeze([
