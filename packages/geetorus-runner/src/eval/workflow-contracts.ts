...
export const RUNNER_WORKFLOW_EVAL_CASE_SCHEMA = "geetorus.runner.workflow-eval-case.v1" as const;
export const RUNNER_WORKFLOW_OBSERVATION_SCHEMA = "geetorus.runner.workflow-observation.v1" as const;
export const RUNNER_WORKFLOW_SCORECARD_SCHEMA = "geetorus.runner.eval-scorecard.v2" as const;
