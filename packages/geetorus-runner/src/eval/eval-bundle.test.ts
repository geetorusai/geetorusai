...
function bundle(overrides: Partial<EvalBundle> = {}): EvalBundle {
  return {
    schema: "geetorus.runner.eval-bundle.v1",
    ...
    runner: { package: "@geetorusai/geetorus-runner", binary: "geetorus-runnerd", version: "0.0.0" },
    controlPlaneAdapter: { kind: "mock", contract: "geetorus.capability.control-plane.v1" },
    faultInjection: [],
    ...overrides,
  };
}
...
describe("bundleId", () => {
  it("is stable and independent of field ordering", () => {
    ...
    const b: EvalBundle = {
      ...
      faultInjection: [],
      controlPlaneAdapter: { contract: "geetorus.capability.control-plane.v1", kind: "mock" },
      runner: { version: "0.0.0", binary: "geetorus-runnerd", package: "@geetorusai/geetorus-runner" },
      grants: ["discovery:tasks:read"],
