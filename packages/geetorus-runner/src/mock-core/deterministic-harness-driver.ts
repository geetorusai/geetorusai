...
export const DETERMINISTIC_HARNESS_DRIVER_CONFIG_SCHEMA =
  "geetorus-runner/deterministic-harness-driver-config/v1" as const;
...
export class DeterministicHarnessDriver implements HarnessDriver {
  ...
  async descriptor(): Promise<HarnessDriverDescriptor> {
    return {
      ...
      displayName: "Geetorus deterministic harness driver",
      version: "1.0.0",
  ...
  async recoverSession(
    ...
    if (
      snapshot.driverKind !== "geetorus-deterministic"
