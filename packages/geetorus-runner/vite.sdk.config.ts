...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: "@geetorusai/geetorus-runner/browser", replacement: resolve(packageRoot, "src/browser/index.ts") },
      { find: "@geetorusai/geetorus-runner/react", replacement: resolve(packageRoot, "src/react/index.ts") },
      { find: "@geetorusai/geetorus-runner/styles.css", replacement: resolve(packageRoot, "styles.css") },
    ],
  },
