...
async function main() {
  ...
  try {
    ...
    assertions.liveIdentity =
      ...
      opened.view.identity.controlPlaneLabel === "Mock Geetorus";
    ...
    assertions.realApiBlocked = guard?.outcome === "no_real_geetorus_request";
    ...
    assertions.capabilityBound = typeof jar.value("geetorus_capability_chat") === "string";
