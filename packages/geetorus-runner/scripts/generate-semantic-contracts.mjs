...
import { GEETORUS_RUNNER_BUILD_METADATA } from "../dist/evals/build-metadata.js";
...
const fixtureCurrent = fixture.runner.catalogSha256 === GEETORUS_RUNNER_BUILD_METADATA.semanticCatalog.sha256;
...
if (process.argv.includes("--check")) {
  ...
  if (!fixtureCurrent) {
    fixture.runner.catalogSha256 = GEETORUS_RUNNER_BUILD_METADATA.semanticCatalog.sha256;
