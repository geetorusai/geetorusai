...
if (dryRun) {
  process.stdout.write(`${JSON.stringify({
    schema: "geetorus.capability.live-codex-matrix-dry-run.v1",
    provider: "codex",
...
const liveBundle = {
  ...
  runner: {
    ...
    binary: "geetorus-runnerd",
    version: packageManifest.version,
  },
  controlPlaneAdapter: {
    kind: "mock",
    contract: "geetorus.capability.mock-state.v1",
  },
  faultInjection: [],
};
...
const report = {
  schema: "geetorus.capability.live-codex-matrix.v1",
  groups: matrix.length,
  providerModel: liveModel,
  matrix,
};
const evidenceDirectory = resolve(packageRoot, ".geetorus-local/evidence/capability");
