...
export const PRP_SCHEMA_ID_PREFIX = "https://geetorus.dev/schemas/prp/";
...
export function assertReplayFixtureCompatibility(fixture) {
  requireSchema(fixture, "geetorus.prp.fixture.v1", "fixture");
  ...
  requireSchema(fixture.identity, "geetorus.prp.identity.v1", "identity");
  requireSchema(fixture.capabilities, "geetorus.prp.capabilities.v1", "capabilities");
  ...
  for (const [index, command] of fixture.commands.entries()) {
    if (command?.schema !== "geetorus.prp.command.v1" && command?.schema !== "geetorus.prp.command.v2") {
  ...
  for (const [index, event] of fixture.events.entries()) {
    requireSchema(event, "geetorus.prp.event.v1", `events[${index}]`);
  ...
  requireSchema(fixture.result, "geetorus.run_result.v1", "result");
  return fixture;
}

export function assertQuestionAdapterFixture(fixture) {
  requireSchema(fixture, "geetorus.question_adapter_fixture.v1", "question fixture");
  requireSchema(fixture.canonicalQuestionSet, "geetorus.question_set.v1", "canonicalQuestionSet");
  requireSchema(fixture.canonicalResponse, "geetorus.question_response.v1", "canonicalResponse");
...
export function assertConformanceFixturePair(fixture, output) {
  if (fixture?.schemaVersion !== "geetorus.runner.conformance.fixture.v1") {
    throw contractError("unsupported_required_schema", `conformance fixture requires ${String(fixture?.schemaVersion)}`);
  }
  if (output?.schemaVersion !== "geetorus.runner.conformance.output.v1") {
