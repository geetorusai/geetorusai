...
- [Standalone adapter](tutorials/standalone-thin-geetorus-adapter.md)
...
- [Standalone adapter](standalone-thin-geetorus-adapter.md)
...
- [Standalone adapter boundary](design/standalone-thin-geetorus-adapter.md)
