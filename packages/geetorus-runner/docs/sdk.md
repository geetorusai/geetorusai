...
| Import | Purpose |
| --- | --- |
| `@geetorusai/geetorus-runner` | Protocol, reducer, and existing package contracts |
| `@geetorusai/geetorus-runner/browser` | Framework-free HTTP/SSE client, protocol types, transcript projection |
| `@geetorusai/geetorus-runner/react` | Hook, reference console, and reusable React components |
| `@geetorusai/geetorus-runner/styles.css` | Scoped light-theme token and component styles |
...
```ts
import { createRunnerClient } from "@geetorusai/geetorus-runner/browser";
...
```tsx
import { useRunnerConsole } from "@geetorusai/geetorus-runner/react";
