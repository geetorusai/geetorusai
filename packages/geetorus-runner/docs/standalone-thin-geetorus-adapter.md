...
It does not install or enable the runner in a Geetorus instance. All active
...
native/legacy invocation counters. It makes no network call to Geetorus.
...
Geetorus instance remains outside this package and requires a separately
reviewed integration.

See the [runnable tutorial](tutorials/standalone-thin-geetorus-adapter.md).
