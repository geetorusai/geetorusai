...
import { Tabs, type TabDefinition } from "@geetorusai/geetorus-runner/react";
import {
...
} from "@geetorus-runner-local/capability";
              ...
              {artifact === null ? (
                <EmptyState title="Run to produce the deterministic timeline.">
                  <p className="pcr7-muted">
                    Fake mode runs entirely in this page against checked-in fixtures. No Geetorus
