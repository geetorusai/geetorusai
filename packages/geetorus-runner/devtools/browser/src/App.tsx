...
> = {
  console: {
    eyebrow: "Geetorus Runner Protocol · Live console",
  ...
  return (
    <main className="app-shell">
      <header className="page-header">
        ...
        <Badge tone="neutral">Standalone · no Geetorus core</Badge>
      </header>
