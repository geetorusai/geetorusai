...
/**
 * Maps each resource id to its payload. The `control_bridge` is the Geetorus
...
export interface RunResourcePayloads {
  ...
  readonly control_bridge: AdapterExecutionTargetGeetorusBridgeHandle;
...
/** The Geetorus Claude settings the fingerprint reads. */
export interface GeetorusClaudeSettingsIdentity {
...
export interface SessionFingerprintIdentity {
  ...
  readonly geetorusClaudeSettings: GeetorusClaudeSettingsIdentity | null;
 ...
 * `geetorus:companyId:agentId:taskKey:fingerprint`. These parts stay out of
