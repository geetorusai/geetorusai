 ...
 */
export const SANDBOX_STARTUP_SPAN_ATTR_PREFIX = "geetorus.sandbox.startup.";
 ...
 * the `geetorus.sandbox.startup.` prefix and a type suffix:
 *
 ...
 * `geetorus.sandbox.startup.` allowlist. It records the wall, work, and diff
