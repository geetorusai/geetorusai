...
// @google/gemini-cli. The bootstrap also sets GEETORUS_NPM_BOOTSTRAPPED=1
...
export function buildSandboxNpmInstallCommand(packageName: string): string {
  ...
  return [
    ENSURE_NPM_PREAMBLE,
    'if [ -n "$GEETORUS_NPM_BOOTSTRAPPED" ]; then',
