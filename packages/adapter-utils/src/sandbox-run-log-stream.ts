...
const TAIL_MARKER_STDOUT = "__GEETORUS_RUN_LOG_STDOUT__";
const TAIL_MARKER_STDERR = "__GEETORUS_RUN_LOG_STDERR__";
const TAIL_MARKER_END = "__GEETORUS_RUN_LOG_END__";
