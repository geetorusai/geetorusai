...
import type { AdapterAuthSessionInternalStatus, AgentAdapterType } from "@geetorusai/shared";
...
export const adapterAuthSessions = pgTable(
  "adapter_auth_sessions",
  {
    ...
    aiConnection: jsonb("ai_connection").$type<import("@geetorusai/shared").AiConnectionLoginIntent>(),
