...
import type { PluginCategory, PluginStatus, GeetorusPluginManifestV1 } from "@geetorusai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<GeetorusPluginManifestV1>().notNull(),
