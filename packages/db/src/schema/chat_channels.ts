...
export const chatEndpoints = pgTable(
  ...
  (table) => [
    ...
    // A native provider identity can back only one live Geetorus endpoint.
    ...
    // two Geetorus agents after both application-level prechecks passed.
    ...
    // two Geetorus agents through two different webhook URLs.
...
export const chatIdentityLinks = pgTable(
  "chat_identity_links",
  {
    ...
    geetorusUserId: text("geetorus_user_id"),
    status: text("status")
...
export const chatConversations = pgTable(
  "chat_conversations",
  {
    ...
    // used for replies while allowing completed Geetorus tasks to roll over.
