...
export interface DatabaseClientOptions {
   ...
   * `pg_stat_activity.application_name`. Lets an operator tell Geetorus's
...
export const DEFAULT_DATABASE_APPLICATION_NAME = "geetorus";
 ...
 * Geetorus's own defaults on top, and the driver defaults apply to the rest
...
/**
 * Fills in Geetorus's defaults for the options the caller left unset: idle
