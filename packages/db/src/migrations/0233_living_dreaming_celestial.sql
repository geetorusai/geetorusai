...
ALTER TABLE "tool_connections" ADD COLUMN IF NOT EXISTS "credential_source" text DEFAULT 'geetorus_vault' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "tool_connections" ADD CONSTRAINT "tool_connections_credential_source_check" CHECK ("tool_connections"."credential_source" in ('geetorus_vault', 'vercel_connect'));--> statement-breakpoint
...
ALTER TABLE "tool_connections" ADD CONSTRAINT "tool_connections_credential_source_one_of_check" CHECK ((
      ("tool_connections"."credential_source" = 'geetorus_vault' and "tool_connections"."external_credential" is null)
      or
