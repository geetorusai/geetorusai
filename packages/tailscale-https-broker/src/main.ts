 ...
 * account — NOT as the Geetorus app/agent account.
 *
 * Usage:
 *   geetorus-tailscale-https-broker            # run the broker
 *   geetorus-tailscale-https-broker --doctor   # read-only preflight, no mutation
 */
