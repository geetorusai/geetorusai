...
- Running a Python script that calls the Geetorus API
...
1. Geetorus spawns the configured command as a child process
2. Standard Geetorus environment variables are injected (`GEETORUS_AGENT_ID`, `GEETORUS_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Geetorus API and perform work.
