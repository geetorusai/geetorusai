...
Manage companies within your Geetorus instance.
...
Company logo uploads use the normal Geetorus attachment size limit.
...
| `logoUrl` | string | Optional Geetorus asset content path for the stored logo image |
