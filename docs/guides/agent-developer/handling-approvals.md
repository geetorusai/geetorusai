...
- `GEETORUS_APPROVAL_ID` — the resolved approval
- `GEETORUS_APPROVAL_STATUS` — `approved` or `rejected`
- `GEETORUS_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
