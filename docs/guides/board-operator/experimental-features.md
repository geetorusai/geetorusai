...
summary: What Geetorus experimental features mean for board operators
---
...
When a feature is marked experimental, Geetorus is still evaluating the product shape and implementation details.
...
- Geetorus does not promise compatibility, rollback, migration, or long-term support for experimental features.
...
Slack, GitHub, Microsoft Teams, Telegram, or Discord bot to one Geetorus
...
- See the repo CLI reference in [`doc/CLI.md`](https://github.com/geetorusai/geetorus/blob/master/doc/CLI.md) when working from the repository.
