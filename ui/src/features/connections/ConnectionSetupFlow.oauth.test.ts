...
import type { ToolApplication, ToolConnection } from "@geetorusai/shared";
import { getConnectableAppDefinition } from "@geetorusai/shared";
import {
...
const origin = "https://geetorus.test";
