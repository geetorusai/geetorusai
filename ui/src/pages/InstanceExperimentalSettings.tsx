...
import { experimentalSettingKey } from "@geetorusai/shared";
...
export function InstanceExperimentalSettings() {
  ...
  // render locked with the "Managed by Geetorus Cloud" badge. Self-hosted
  ...
  const enableGeetorusDeveloperMode =
    experimentalQuery.data?.enableGeetorusDeveloperMode === true;
    ...
    <div className="max-w-6xl space-y-6">
      ...
      <section className="space-y-3" aria-labelledby="experimental-features-heading">
        ...
        <ExperimentalToggleCard
          title="Beta skills"
          description="Allow agents to pin beta releases of the Geetorus core skill. Disabling this returns every agent to the default live skill without removing saved pins."
        ...
        <ExperimentalToggleCard
          ...
          description="Show Geetorus-managed built-in agent surfaces, including built-in roster badges, the Built-in agents tab, and built-in agent setup controls."
        ...
        <ExperimentalToggleCard
          ...
          description="Allow new Codex agents to select the experimental Rust Geetorus Runner, including authenticated runner ingress when a sandbox requires it. Onboarding continues to use legacy adapters. Turning this off hides the choice without affecting existing native runs."
          ...
          ariaLabel="Toggle Geetorus Runner experimental setting"
        />
      ...
      <section className="space-y-3" aria-labelledby="developer-mode-heading">
        <div className="space-y-1">
          <h2 id="developer-mode-heading" className="text-sm font-semibold">
            Geetorus Developer Mode
          </h2>
          <p className="text-sm text-muted-foreground">
            Internal tools for developing, testing, and debugging Geetorus.
          </p>
        </div>

        <ExperimentalToggleCard
          title="Geetorus Developer Mode"
          description="Show internal Geetorus maintainer tools and observability links, including Honeycomb trace queries on run pages."
          checked={enableGeetorusDeveloperMode}
          onCheckedChange={(checked) =>
            toggleMutation.mutate({ enableGeetorusDeveloperMode: checked })
          }
          disabled={toggleMutation.isPending}
          settingKey="enableGeetorusDeveloperMode"
          managed={managedKeys.enableGeetorusDeveloperMode}
          ariaLabel="Toggle Geetorus developer mode experimental setting"
        />
