...
describe("CompanyAccess", () => {
      ...
      members: [
        {
          ...
          user: {
            id: "user-1",
            email: "codexcoder@geetorus.local",
            name: "Codex Coder",
    ...
    listJoinRequestsMock.mockResolvedValue([
      {
        ...
        requestEmailSnapshot: "board@geetorus.local",
  ...
  it("renders a compact member table without redundant explanatory copy", async () => {
    ...
    expect(container.textContent).not.toContain("Manage the people who can work in Geetorus");
