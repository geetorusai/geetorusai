...
import type { WorkspaceOverviewItem, WorkspaceOverviewResponse } from "@geetorusai/shared";
...
function overviewItem(overrides: Partial<WorkspaceOverviewItem> = {}): WorkspaceOverviewItem {
  return {
    ...
    projectUrlKey: overrides.projectUrlKey ?? "geetorus-app",
    projectName: overrides.projectName ?? "Geetorus App",
...
describe("Workspaces", () => {
  ...
  it("uses the bounded overview endpoint and renders grouped workspace cards with linked task summaries", async () => {
    ...
    expect(container.querySelector('a[href="/projects/geetorus-app/workspaces"]')).not.toBeNull();
