...
import type { PatchInstanceGeneralSettings, BackupRetentionPolicy } from "@geetorusai/shared";
import {
...
const FEEDBACK_TERMS_URL = import.meta.env.VITE_FEEDBACK_TERMS_URL?.trim() || "https://geetorus.ing/tos";
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              ...
              Geetorus Labs. Votes are always saved locally.
            </p>
            {FEEDBACK_TERMS_URL ? (
              <a
      ...
      <section>
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="max-w-2xl text-sm text-muted-foreground">
              Sign out of this Geetorus instance. You will be redirected to the login page.
            </p>
          </div>
          <Button
            variant="outline"
