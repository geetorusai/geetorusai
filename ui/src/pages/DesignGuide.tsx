...
import type { CompanySecret, EnvBinding, Issue } from "@geetorusai/shared";
...
import type { IssueWorkProduct } from "@geetorusai/shared";
...
function TaskExecutionControlsExample() {
  ...
  return <div className="max-w-xl space-y-4">
    ...
    <TaskChatProjectCreatedCard item={{ id: "design-project", kind: "project_created", projectId: "example-project", name: "Onboarding improvements", description: "Help new teams reach their first useful result.", timestamp: "2026-09-11T00:00:00Z", repositories: [{ id: "1", name: "geetorusai/geetorus", url: "https://github.com/geetorusai/geetorus" }] }} />
    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Every component, style, and pattern used across Geetorus.
        </p>
      </div>
      ...
      <Section title="Breadcrumb">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Geetorus App</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {["running", "queued", "succeeded", "failed", "timed_out", "cancelled", "interrupted"].map((status) => (
              <AgentRunCard
                ...
                issue={{ identifier: "PAP-559", title: "Recreate this wireframe on pages Geetorus", status: status === "succeeded" ? "done" : "in_progress" }}
              />
            ))}
          </div>
      ...
      <Section title="Source Repositories">
        ...
        <SubSection title="Selected and searchable">
          <RepositoryEditor selected={[{ id: "1", fullName: "geetorusai/geetorus", url: "https://github.com/geetorusai/geetorus", connections: ["Your GitHub"] }]}
            available={[{ id: "2", fullName: "geetorusai/docs", url: "https://github.com/geetorusai/docs", connections: ["Company GitHub"] }]}
      ...
      <Section title="Inline Banner">
        ...
        <div className="space-y-3">
          ...
          >
            Ships with Geetorus and powers <strong>Briefs</strong>. It can be paused but not deleted.
          </InlineBanner>
          <InlineBanner
            tone="warning"
