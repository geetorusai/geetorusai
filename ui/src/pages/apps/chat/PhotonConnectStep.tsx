        ...
        <fieldset className="space-y-3">
          ...
          {!inspection.data.eligible && (
            <p role="alert" className="text-sm text-destructive">
              {inspection.data.allocation === "shared"
                ...
                : "No eligible dedicated number is available. Check the line allocation in Photon and existing Geetorus channels."}
            </p>
          )}
          {inspection.data.allocation === "shared" && inspection.data.eligible && (
            <p className="text-sm text-muted-foreground">
              ...
              then use the number Photon assigns to that sender. Geetorus identity linking is
