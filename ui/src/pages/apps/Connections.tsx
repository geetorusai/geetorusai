...
export function Connections() {
  ...
  const startConnectorEnrollment = useMutation({
    ...
    onError: (error) => pushToast({
      title: "Couldn’t reach Geetorus Cloud",
  ...
  if (status?.configured) {
    return (
      <div className="flex flex-wrap items-center gap-3 rounded-lg border border-border bg-card px-4 py-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="text-sm font-semibold text-foreground">Geetorus-managed sign-in is ready</div>
  ...
  if (unavailable) {
    return (
      <div className="flex items-center gap-3 rounded-lg border border-border bg-card px-4 py-3">
        ...
        <div className="text-sm text-muted-foreground">Geetorus Cloud enrollment status is unavailable.</div>
      </div>
    );
  }
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-lg border border-border bg-card px-4 py-3">
      ...
      <div className="min-w-0 flex-1">
        <div className="text-sm font-semibold text-foreground">
          {status?.status === "pending" ? "Finish Geetorus Cloud enrollment" : "Enable Geetorus-managed sign-in"}
        </div>
