import type { ToolConnection } from "@geetorusai/shared";
...
export interface ComposioServicesResponse {
  ...
  /** Composio `user_id` these accounts belong to (`geetorus:{companyId}`). Not a secret. */
  userId: string;
  services: Array<{
...
export interface ComposioServiceRow {
  ...
  connectedAccountStatus: string | null;
  /** The Geetorus child connection for this toolkit, once one exists. */
  childConnectionId: string | null;
