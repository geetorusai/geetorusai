  ...
  const saveStage = useMutation({
    ...
    onError: async (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : "Geetorus could not save the stage.",
        tone: "error",
      });
    },
  });
      ...
      pushToast({
        ...
        body: error instanceof ApiError
          ...
          : error instanceof Error
            ? error.message
            : "Geetorus could not save the stage secrets.",
        tone: "error",
      });
    },
  });
  ...
  const deleteStage = useMutation({
    ...
    onError: (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : "Geetorus could not delete the stage.",
        tone: "error",
      });
    },
  });
  ...
  const saveStrictTransitions = useMutation({
    ...
    onError: (error) => {
      ...
      pushToast({
        ...
        body: error instanceof Error ? error.message : "Geetorus could not update transition rules.",
        tone: "error",
      });
    },
  });
      ...
      <div className="flex items-start justify-between gap-4 border-b border-border p-4">
        <div className="space-y-1">
          ...
          <p className="max-w-md text-sm text-muted-foreground">
            The agent decides what the pieces are. Geetorus creates and tracks them.
          </p>
        </div>
        <ToggleSwitch
                            ...
                            <FieldRow label="Project context">
                              ...
                              {selectedAutomationProject && !selectedAutomationProjectWorkspace ? (
                                <p className="mt-2 text-xs text-muted-foreground">
                                  This project has no saved workspace default. Geetorus will use the project fallback when automation runs.
                                </p>
                              ) : null}
                            </FieldRow>
