  ...
  return (
    <>
      <div className="flex items-start gap-4">
        ...
        />
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-(--tracking-caps) text-zinc-500">You&apos;ve been invited to join Geetorus</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-400">
          {mode === "sign_up"
            ? "Start with a Geetorus account. After that, you'll come right back here to accept the invite for Acme Robotics."
        ...
        <div className="flex min-h-(--sz-420px) flex-col justify-center bg-background px-8 py-10">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-8 flex items-center gap-2">
              ...
              <span className="text-sm font-medium">Geetorus</span>
            </div>
            <h3 className="text-xl font-semibold">
              {mode === "sign_in" ? "Sign in to Geetorus" : "Create your Geetorus account"}
            </h3>
      ...
      <Card className="rounded-(--rad-28) shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3 rounded-2xl border border-border px-4 py-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  This URL includes the current Geetorus domain returned by the server.
                </div>
              </div>
            ...
            >
              https://geetorus.local/invite/new-token
            </button>
          ...
          <InviteLandingShell
            left={
              <InviteSummaryPanel
                ...
                description="Create your Geetorus account first. If you already have one, switch to sign in and continue the invite with the same email."
