            ...
            {loading ? (
              ...
              <>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  Geetorus could not verify this agent&apos;s current connection. Your existing setup was not changed.
                </p>
              </>
            ) : dedicatedIdentity ? (
              <>
              ...
              <>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  At run start, Geetorus uses the personal GitHub connection of the person responsible for the task.
                </p>
                {personalIdentity ? (
  ...
  return (
    <div className="space-y-4">
      <EnforcementBanner
        ...
        body={
          <>
            This is exactly the tool set Geetorus will accept for{" "}
              ...
              {catalogLoading ? (
                ...
                <>
                  <p className="text-(length:--text-micro) text-muted-foreground">
                    Tools the agent could name but Geetorus would block:
                  </p>
