  ...
  return (
    <Card>
      <CardContent className="flex flex-col items-center gap-3 py-14 text-center">
        ...
        <div>
          <p className="text-sm font-medium text-foreground">Agent audit is a Geetorus Enterprise view</p>
...
export function AuditFeed({
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        Recorded by Geetorus — entries can't be edited. Sensitive values are never stored.
      </p>
    </div>
  );
}
