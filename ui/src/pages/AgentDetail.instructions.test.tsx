...
import type { Agent, AgentInstructionsBundle, AgentInstructionsFileDetail, AgentInstructionsFileSummary } from "@geetorusai/shared";
...
function makeBundle(
  ...
  return {
    ...
    companyId: "company-1",
    mode: "managed",
    rootPath: "/geetorus/agents/agent-1/instructions",
    managedRootPath: "/geetorus/agents/agent-1/instructions",
    entryFile,
    resolvedEntryPath: `/geetorus/agents/agent-1/instructions/${entryFile}`,
    editable: true,
    warnings: [],
