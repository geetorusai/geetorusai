...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@geetorusai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Geetorus file storage for ${selectedCompany.name}.`
    : "Select an organization to upload an avatar into Geetorus storage.";
