...
export const sampleTeam: CatalogTeam = {
  id: "geetorusai:bundled:company-defaults:core-exec-team",
...
export const optionalTeam: CatalogTeam = {
  ...sampleTeam,
  id: "geetorusai:optional:software-development:platform-pod",
  key: "geetorusai/optional/software-development/platform-pod",
  kind: "optional",
...
export const warnTeam: CatalogTeam = {
  ...sampleTeam,
  id: "geetorusai:optional:research:lab-with-local-source",
...
export const onboardingTeams: CatalogTeam[] = [
  ...
  {
    ...sampleTeam,
    id: "geetorusai:bundled:company-defaults:growth-pod",
    key: "geetorusai/bundled/company-defaults/growth-pod",
    slug: "growth-pod",
    name: "Growth Pod",
    description:
  ...
  {
    ...sampleTeam,
    id: "geetorusai:bundled:company-defaults:support-pod",
    key: "geetorusai/bundled/company-defaults/support-pod",
    slug: "support-pod",
    name: "Support Pod",
