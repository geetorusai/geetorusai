...
import type { ExportFidelityReport } from "@geetorusai/shared/portability-fidelity";
...
function buildExportPreviewResult() {
  return {
    ...
    manifest: {
      ...
      company: { name: "Geetorus", description: null },
      schemaVersion: 1,
      generatedAt: "2026-01-01T00:00:00.000Z",
      source: null,
    },
    files: { "README.md": "# Geetorus\n" },
    fileInventory: [],
...
function buildFidelityReport(warnings: ExportFidelityReport["warnings"]): ExportFidelityReport {
  return {
    schema: "geetorus-export-fidelity-v1",
    companyId: "company-1",
    counts: {
      labelDefinitions: 0,
...
describe("CompanyExport", () => {
  ...
  beforeEach(() => {
    ...
    mockCompaniesApi.exportBundle.mockResolvedValue({ rootPath: "geetorus", files: {} });
  ...
  it("shows a retryable error instead of a false loading state", async () => {
    ...
    expect(container.textContent).toContain("Geetorus export");
  });
