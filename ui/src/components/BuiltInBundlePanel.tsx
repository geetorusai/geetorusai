 ...
 * that one resource to Geetorus's newest shipped default without touching
...
function resourceActionCopy(
  ...
  if (resource.stockStatus === "stock_update_available") {
    return {
      ...
      body: `You haven't edited this, so Geetorus will replace it with the newer shipped version. Nothing you customized is affected, and your adapter credentials and settings are not touched.`,
      confirmLabel: "Update",
      triggerLabel: "Update",
    };
  }
  if (resource.stockStatus === "operator_modified") {
    return {
      ...
      body: `This replaces your edited version with Geetorus's current default. Your edits can't be recovered. Adapter credentials and settings are not touched.`,
  ...
  if (resource.stockStatus === "missing") {
    return {
      ...
      body: `This resource is missing. Geetorus will recreate it from the shipped default. Adapter credentials and settings are not touched.`,
...
function driftDetail(resource: BuiltInManagedResourceState): string | undefined {
  switch (resource.stockStatus) {
    ...
    case "stock_update_available":
      return "Geetorus shipped a newer default.";
    case "missing":
              ...
              <>
                {onRunRoutine && (
                  <ConfirmActionButton
                    ...
                    body="Geetorus will create one routine task now. This does not enable the weekly schedule or turn on background work."
                ...
                {scheduleEnabled
                  ? onDisableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Geetorus will stop future scheduled Reflection Coach runs. Manual Run once remains available."
                  ...
                  : onEnableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Geetorus will allow Reflection Coach to create routine tasks on the weekly schedule. It can spend tokens when those tasks run."
