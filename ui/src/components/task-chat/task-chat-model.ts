...
export type { GeetorusQuestionResponse, GeetorusQuestionSet };
...
export interface TaskChatRuntimeRequestItem {
  ...
  questionSet?: GeetorusQuestionSet | null;
...
export type TaskChatRuntimeRequestDecision =
  ...
  | { action: "submit"; response: GeetorusQuestionResponse };
...
export interface TaskChatTurnItem {
  ...
  /** Durable response shown after the ordered Geetorus Runner timeline. */
