...
import type { IssueAttachment, IssueWorkMode } from "@geetorusai/shared";
import type { RunnerGoalCapability } from "@geetorusai/shared";
...
export function TaskChatComposer({
  ...
  return (
    <div
      className={cn(
        streamlined
          ? "geetorus-task-chat-composer rounded-(--radius-task-composer) border border-border bg-card p-(--sz-18px) shadow-(--shadow-task-composer) dark:border-0 dark:bg-muted dark:shadow-none"
          : "geetorus-task-chat-composer rounded-xl bg-card p-(--sz-18px)",
        mobile && "p-2",
      )}
      onKeyDownCapture={(e) => {
