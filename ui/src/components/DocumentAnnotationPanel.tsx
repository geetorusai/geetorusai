    ...
    return (
      <Sheet open={props.open} onOpenChange={props.onOpenChange}>
        <SheetContent
          ...
          className="geetorus-doc-annotation-sheet z-(--z-60) flex max-h-(--sz-88vh) flex-col rounded-none border-t border-border bg-popover p-0 text-popover-foreground shadow-2xl"
        >
