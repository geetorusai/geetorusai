...
import type { CompanySecret, EnvBinding, UserSecretDefinition } from "@geetorusai/shared";
...
const DEFAULT_RESERVED_PREFIXES = ["GEETORUS_"];

const DEFAULT_HINT =
  "Set the KEY to the env var name the process expects, for example GH_TOKEN. Choose a secret to resolve a stored value at run start. GEETORUS_* variables are injected automatically.";
...
export interface EnvironmentVariablesEditorProps {
  ...
  /** Read-only rendering. */
  disabled?: boolean;
  /** Prefixes flagged as reserved/auto-provided. Default `["GEETORUS_"]`. */
