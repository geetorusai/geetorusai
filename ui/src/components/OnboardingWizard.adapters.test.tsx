...
const ONBOARDING_STORAGE_KEY = "geetorus-onboarding-state";
...
describe("OnboardingWizard adapter selection", () => {
  ...
  it("keeps onboarding on legacy adapters even when Geetorus Runner is enabled", async () => {
    mockAdapterRegistry.list = [
  ...
  it("normalizes a saved Geetorus Runner draft before adapter discovery resolves", async () => {
