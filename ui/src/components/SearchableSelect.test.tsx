        ...
        options: [
          {
            ...
            value: "path-only",
            label: "Geetorus app",
            searchText: "/srv/geetorus/mobile-checkout",
          },
          {
            key: "all:mobile",
            value: "mobile",
            label: "Mobile agent chat",
            searchText: "/srv/geetorus/agent-chat",
          },
        ],
      },
    ];
  ...
  it("filters workspace options, moves with arrows, and selects the workspace id with Enter", async () => {
    ...
    const groups = buildWorkspaceSelectGroups([
      ...
      workspace({
        ...
        name: "Marketing site",
        cwd: "/srv/geetorus/home/marketing-site",
    ...
    expect(container.textContent).toContain("Geetorus app");
    ...
    expect(selectedOptionKey()).toBe("recent:workspace-geetorus");
    keyDown(input!, "ArrowDown");
    await flush();
    expect(selectedOptionKey()).toBe("all:workspace-geetorus");
    ...
    expect(onValueChange).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        key: "all:workspace-geetorus",
        value: "workspace-geetorus",
        workspaceId: "workspace-geetorus",
      }),
    );
