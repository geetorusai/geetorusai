...
import type { Issue, IssueAttachment, IssueDocument, IssueWorkProduct } from "@geetorusai/shared";
import { artifactReviewDocumentKey } from "@geetorusai/shared";
  ...
  it("groups compact rows by producing run", async () => {
    ...
    mockIssuesApi.listWorkProducts.mockResolvedValue([
      makeMarkdownWorkProduct({
        ...
        url: "https://github.com/geetorusai/geetorus/pull/1",
        createdByRunId: runOne,
        metadata: { repo: "geetorusai/geetorus", number: 1, baseRef: "master", headRef: "artifacts" },
      }),
      makeMarkdownWorkProduct({
