...
const TOOL_EXECUTION_SCHEMA = "geetorus.tool.execution.v1";
const RUN_RESULT_SCHEMA = "geetorus.run_result.v1";
const RUN_TERMINAL_SCHEMA = "geetorus.prp.terminal.v1";
...
function canonicalQuestionSet(
  ...
  if (
    !candidate
    || candidate.schema !== "geetorus.question_set.v1"
...
function canonicalQuestionResponse(
  ...
  const candidate = record(value);
  return candidate
    && candidate.schema === "geetorus.question_response.v1"
...
const PROVIDER_ACTIVITY_PRESENTATIONS = {
  ...
  "model.route.changed": {
    schema: "geetorus.model.route_changed.v1",
    idKey: "routeId",
    name: "model",
    summaryKeys: ["reason", "effectiveModel"],
  },
  "model.verification.updated": {
    schema: "geetorus.model.verification.v1",
    idKey: "verificationId",
    name: "model",
    summaryKeys: ["summary"],
  },
  "context.compacted": {
    schema: "geetorus.context.compacted.v1",
    idKey: "compactionId",
    name: "context",
    summaryKeys: ["reason"],
  },
  "artifact.viewed": {
    schema: "geetorus.artifact.viewed.v1",
    idKey: "artifactId",
    name: "artifact",
    summaryKeys: ["title", "reference"],
  },
  "artifact.generated": {
    schema: "geetorus.artifact.generated.v1",
    idKey: "artifactId",
    name: "artifact",
    summaryKeys: ["failure", "reference"],
  },
  "review.mode.changed": {
    schema: "geetorus.review.mode_changed.v1",
    idKey: "reviewId",
    name: "review",
    summaryKeys: ["scope", "state"],
  },
  "hook.started": {
    schema: "geetorus.hook.v1",
    idKey: "hookId",
    name: "hook",
  ...
  "memory.citation.referenced": {
    schema: "geetorus.memory.citation.v1",
    idKey: "citationId",
    name: "memory",
    summaryKeys: ["label"],
  },
  "safety.review.started": {
    schema: "geetorus.safety.review.v1",
    idKey: "reviewId",
    name: "safety",
  ...
  "terminal.input.sent": {
    schema: "geetorus.terminal.input_sent.v1",
    idKey: "executionId",
    name: "terminal",
    summaryKeys: ["inputClass"],
  },
  "wait.started": {
    schema: "geetorus.wait.v1",
    idKey: "waitId",
    name: "wait",
    summaryKeys: ["reason"],
  },
...
export function nativeRunEventsToTranscript(events: readonly HeartbeatRunEvent[]): TranscriptEntry[] {
  ...
  for (const event of orderedEvents) {
    ...
    if (event.eventType === "provider.notice.recorded" && payload.schema === "geetorus.provider.notice.v1") {
      entries.push({
