...
import type { EnvBinding, RoutineDetail as RoutineDetailType } from "@geetorusai/shared";
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-md border border-border bg-muted/20 px-4 py-3 text-xs text-muted-foreground">
        ...
        project and agent env. <span className="font-mono">GEETORUS_*</span> names are reserved.
      </div>
      ...
      {secretMessage ? (
        <div className="space-y-3 rounded-lg border border-blue-500/30 bg-blue-500/5 p-4 text-sm">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Save this now. Geetorus will not show the secret value again.
            </p>
          </div>
          <div className="space-y-3">
