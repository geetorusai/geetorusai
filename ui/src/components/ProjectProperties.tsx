...
import type { Project, SharedWorkspaceConcurrency } from "@geetorusai/shared";
            ...
            */}
            {hideHostPaths ? (
              codebase.origin === "managed_checkout" ? (
                <div className="text-(length:--text-micro) text-muted-foreground">Geetorus-managed folder.</div>
              ) : null
            ) : (
            ...
            {hasAdditionalLegacyWorkspaces && (
              <div className="text-(length:--text-micro) text-muted-foreground">
                Additional legacy workspace records exist on this project. Geetorus is using the primary workspace as the codebase view.
              </div>
            )}
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <DraftInput
                            ...
                            immediate
                            className="w-full rounded border border-border bg-transparent px-2 py-1 text-xs font-mono outline-none"
                            placeholder=".geetorus/worktrees"
                          />
                        </div>
                        <div>
                          <div className="mb-1 flex items-center gap-1.5">
