...
import type { ActivityEvent, Issue, RunLivenessState } from "@geetorusai/shared";
...
describe("IssueRunLedger", () => {
  ...
  it("renders legacy evaluation context with watchdog actions and a silence badge", () => {
    ...
    expect(container.textContent).toContain("Geetorus did not create new delegated recovery work");
  ...
  it.each([
    ...
    expect(container.textContent).toContain("Geetorus did not create or assign a recovery task");
