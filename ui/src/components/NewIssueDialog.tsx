import { normalizeLegacyRunnerProvider } from "@geetorusai/adapter-utils";
import { memo, useState, useEffect, useRef, useCallback, useMemo, type ChangeEvent, type CSSProperties, type DragEvent, type RefObject } from "react";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import type { AgentEnvConfig, EnvBinding, IssueWorkMode } from "@geetorusai/shared";
...
const DRAFT_KEY = "geetorus:issue-draft";
...
export function NewIssueDialog() {
  ...
  const catalogProvider = assigneeAdapterType === "geetorus_runner" ? String(normalizeLegacyRunnerProvider(selectedAssigneeAgent?.adapterConfig ?? {}).provider ?? "codex") : undefined;
    ...
    >
      <DialogContent
        ...
        onPointerDownOutside={(event) => {
          ...
          if (target?.closest("[data-radix-popper-content-wrapper], [data-geetorus-floating-ui]")) {
            event.preventDefault();
          }
        }}
      >
