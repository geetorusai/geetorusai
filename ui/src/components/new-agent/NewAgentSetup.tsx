...
import { DEFAULT_CODEX_LOCAL_MODEL } from "@geetorusai/adapter-codex-local";
import {
...
import { ADAPTER_AUTH_MISSING_CHECK_CODE } from "@geetorusai/shared";
...
function Setup({
  ...
  const isRunner = adapterType === "geetorus_runner";
