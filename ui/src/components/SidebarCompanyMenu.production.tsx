...
import { hidesCompanyPage, type Company } from "@geetorusai/shared";
...
export function SidebarCompanyMenu({ open: controlledOpen, onOpenChange }: SidebarCompanyMenuProps = {}) {
  ...
  // In Geetorus Cloud the switcher lists the signed-in user's stacks
  ...
  // that hides that surface via GEETORUS_HIDDEN_SETTINGS (company.invites or
  // company.members) hides this shortcut too. This is the per-deployment knob
  // Geetorus Cloud uses to drop the shortcut on its managed stacks while
