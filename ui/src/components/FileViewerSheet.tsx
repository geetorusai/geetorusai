...
const FILE_VIEWER_LABELLED_BY_ID = "geetorus-file-viewer-title";
const FILE_VIEWER_DESCRIBED_BY_ID = "geetorus-file-viewer-description";
...
export function FileContentViewer({ content, highlightedLine, onLoaded }: FileContentViewerProps) {
  ...
  const rawSourceView = (
    <div
      ...
      tabIndex={0}
      className="geetorus-file-viewer-code flex-1 overflow-auto bg-(--code-bg-resolved) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset"
    >
