...
import type { CompanySecret, RoutineEnvConfig } from "@geetorusai/shared";
    ...
    <div className="space-y-5">
      <div className="flex items-start gap-2 rounded-md border border-border bg-muted/20 px-4 py-3 text-xs text-muted-foreground">
        ...
        <p>
          ...
          matching project and agent env on collisions. <span className="font-mono">GEETORUS_*</span> names
          are reserved.
        </p>
      </div>
