...
import type { Agent, ExecutionWorkspace, Project, RoutineVariable } from "@geetorusai/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/geetorus/project-1",
      effectiveLocalFolder: "/tmp/geetorus/project-1",
