  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative geetorus-mdxeditor-scope",
    ...
    >
      <MarkdownEditorRichErrorBoundary onError={handleRichEditorRenderError}>
        <MDXEditor
          ...
          className={cn("geetorus-mdxeditor", !bordered && "geetorus-mdxeditor--borderless")}
          contentEditableClassName={cn(
            "geetorus-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
            contentClassName,
          )}
