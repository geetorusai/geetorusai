...
import type { Agent, Environment, UserSecretDefinition } from "@geetorusai/shared";
import { getEnvironmentCapabilities } from "@geetorusai/shared";
...
vi.mock("../context/CompanyContext", () => ({
  useCompany: () => ({
    companies: [{ id: "company-1", name: "Geetorus" }],
...
describe("AgentConfigForm environment selector", () => {
  ...
  it("labels the platform-managed instance default by name, without the driver key", async () => {
    ...
    expect(selector?.textContent).toContain("Default: Geetorus Computer");
    expect(selector?.textContent).toContain("Geetorus Computer");
