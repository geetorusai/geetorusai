...
import { isSystemIssueDocumentKey } from "@geetorusai/shared";
...
const getFoldedDocumentsStorageKey = (issueId: string) => `geetorus:issue-document-folds:${issueId}`;
...
export function IssueDocumentsSection({
  ...
  const documentBodyContentClassName = "geetorus-edit-in-place-content min-h-(--sz-220px) text-sm leading-7";
