...
const publicationFeedback: Record<ChatPublicationState, PublicationFeedback> = {
  awaiting_consent: {
    ...
    body: "The recipient must accept the file card in Microsoft Teams. The file is not delivered yet; this send identity is kept while Geetorus waits.",
    tone: "info",
  },
  published: {
  ...
  pending: {
    ...
    body: "Delivery is still pending. Your draft is kept until Geetorus confirms publication.",
    tone: "info",
  },
  streaming: {
    title: "Publishing to channel",
    body: "Delivery is still in progress. Your draft is kept until Geetorus confirms publication.",
    tone: "info",
  },
  retry: {
    title: "Delivery retry scheduled",
    body: "Geetorus will retry this publication. Your draft and retry identity are kept.",
    tone: "warn",
  },
  delivery_unknown: {
      ...
      {composing && (
        <div className="space-y-2 border-t border-border pt-3">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">
                {binding.provider === "github"
                  ? "GitHub Apps cannot upload file bytes in comments. Checked files stay on the Geetorus task; GitHub receives an authenticated task link when this Board has a public URL, or a private-task notice otherwise."
            ...
            >
              ...
              {publicationStatus.isError && (
                <p role="alert" className="text-muted-foreground">
                  ...
                  Geetorus will check again without sending another update.
                </p>
              )}
          ...
          <div className="flex items-center justify-between gap-3">
            <p className="text-xs text-muted-foreground">
              Ordinary board comments remain Geetorus-only.
            </p>
            <Button
              size="sm"
              disabled={
