...
import { GeetorusLoading } from "./AnimatedGeetorusIcon";

describe("GeetorusLoading", () => {
  it("renders an accessible full-page loading state", () => {
    const html = renderToStaticMarkup(<GeetorusLoading />);
  ...
  it("allows containing layouts to override the full-page height", () => {
    const html = renderToStaticMarkup(<GeetorusLoading className="min-h-0" />);
