...
import type { FeedbackDataSharingPreference, FeedbackVoteValue } from "@geetorusai/shared";
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Choose whether voted AI outputs can be shared with Geetorus Labs. This
