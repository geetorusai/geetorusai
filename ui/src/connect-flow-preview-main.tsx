...
import { isValidBrowserCode } from "@geetorusai/shared";
import {
  CARD_ENTER,
  CARD_EXIT,
  CARD_EXIT_MS,
...
const OAUTH_URL: Record<string, string> = {
  claude_local: "https://claude.ai/oauth/authorize?code=true&client=geetorus",
        ...
        <div className="pt-6">
          <OnboardingHeading
            ...
            lede={
                ...
                : "Geetorus works with your existing subscription or API keys."
            }
          />
        </div>
