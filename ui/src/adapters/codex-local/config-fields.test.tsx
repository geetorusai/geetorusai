...
describe("Geetorus Runner Codex configuration", () => {
  ...
  it("offers ACPX Claude without a redundant agent selector", () => {
    ...
    expect(html).toContain("Allow Geetorus reads");
  });
  ...
  it("falls back to the fail-closed Codex permission mode", () => {
    ...
    expect(html).toContain("cannot start or recover a Geetorus Runner run");
