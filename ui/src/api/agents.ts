...
import { isUuidLike, normalizeAgentUrlKey } from "@geetorusai/shared";
...
export const agentsApi = {
  ...
  startAdapterAuthLogin: (
    companyId: string,
    type: string,
    data: { environmentId: string; ttlSeconds?: number; aiConnection?: import("@geetorusai/shared").AiConnectionLoginIntent },
  ) =>
  ...
  startClaudeSetupTokenLogin: (
    companyId: string,
    data: { environmentId: string; overwrite?: ClaudeSetupTokenOverwrite; aiConnection?: import("@geetorusai/shared").AiConnectionLoginIntent },
  ) =>
