...
import { getOrCreateGeetorusReactRoot } from "./lib/react-root";
...
if (!rootElement) throw new Error("Geetorus root element is missing");

getOrCreateGeetorusReactRoot(window, rootElement).render(
  <StrictMode>
    <AppErrorBoundary>
