...
describe("cloudLinks", () => {
  it("resolves stack links against the cloud origin", () => {
    expect(cloudStackEnterUrl("https://app.geetorus.app", "acme")).toBe(
      "https://app.geetorus.app/stacks/acme/enter",
    );
    expect(cloudStackCreateUrl("https://app.geetorus.app")).toBe(
      "https://app.geetorus.app/stacks/new",
    );
  });
  ...
  it("escapes slugs so a crafted portfolio entry cannot climb the path", () => {
    expect(cloudStackEnterUrl("https://app.geetorus.app", "../../evil")).toBe(
      "https://app.geetorus.app/stacks/..%2F..%2Fevil/enter",
    );
  });
  ...
  it("returns null without a usable base or slug", () => {
    ...
    expect(cloudStackEnterUrl("https://app.geetorus.app", "  ")).toBeNull();
