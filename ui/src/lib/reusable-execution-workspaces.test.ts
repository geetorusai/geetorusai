...
describe("buildReusableExecutionWorkspaceOptionGroups", () => {
  ...
  it("builds stable display and search metadata", () => {
    ...
    expect(option.label).toBe("Geetorus app");
    expect(option.description).toBe("feature/workspaces");
    expect(option.searchText).toBe("Geetorus app active feature/workspaces /repo/geetorus workspace-1");
  });
  ...
  it("does not match query letters spread across unrelated workspace text", () => {
    const groups = buildReusableExecutionWorkspaceOptionGroups([
      workspace({
        ...
        cwd: "/srv/geetorus/home/geetorusai/geetorus/.geetorus/worktrees/PAP-11694-editing-routine-bodies",
      ...
      workspace({
        ...
        cwd: "/srv/geetorus/home/geetorusai/geetorus/.geetorus/worktrees/PAP-11446-on-mobile-agent-chat",
      ...
      workspace({
        ...
        cwd: "/srv/geetorus/home/geetorusai/geetorus/.geetorus/worktrees/PAP-11429-live-simultaneously",
  ...
  it("scores visible label matches ahead of hidden path matches", () => {
    const groups = buildReusableExecutionWorkspaceOptionGroups([
      workspace({
        id: "path-only-mobile",
        name: "Geetorus app",
        cwd: "/srv/geetorus/mobile-checkout",
