import type { Issue, IssueStatus } from "@geetorusai/shared";

export const RECENT_TASKS_LIMIT = 5;
export const RECENT_TASKS_UPDATED_EVENT = "geetorus:recent-tasks-updated";
const STORAGE_PREFIX = "geetorus.recentTasks.v2:";
const LEGACY_STORAGE_PREFIX = "geetorus.recentTasks:";
