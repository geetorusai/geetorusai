...
export const ATTENTION_GROUP_BY_KEY = "geetorus:attention:group-by";
export const ATTENTION_SORT_KEY = "geetorus:attention:sort";
export const ATTENTION_FILTERS_KEY_PREFIX = "geetorus:attention:filters";
export const ATTENTION_COLLAPSED_GROUPS_KEY_PREFIX = "geetorus:attention:collapsed-groups";
