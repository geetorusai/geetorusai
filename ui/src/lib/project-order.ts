...
export const PROJECT_ORDER_UPDATED_EVENT = "geetorus:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "geetorus:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "geetorus.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "geetorus.projectSortMode";
