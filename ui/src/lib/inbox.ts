...
export const DISMISSED_KEY = "geetorus:inbox:dismissed";
export const READ_ITEMS_KEY = "geetorus:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "geetorus:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "geetorus:inbox:issue-columns";
export const INBOX_NESTING_KEY = "geetorus:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "geetorus:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "geetorus:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "geetorus:inbox:collapsed-groups";
export const INBOX_COLLAPSED_PARENTS_KEY_PREFIX = "geetorus:inbox:collapsed-parents";
