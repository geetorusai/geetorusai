import type { PipelineCaseLiveness } from "@geetorusai/shared";
...
const AUTO_RETRY_NOTE =
  "Geetorus retries automatically once the blocker clears — you don't need to move the item by hand.";
...
const NO_ACTION_PATH_BODY =
  "Geetorus can't see anything to work on next here — no automation, retry, blocker, or review. " +
  ...
  switch (liveness.reason) {
    ...
    case "permission_preflight_failed":
      return {
        ...
        retryLabel: "",
        helperNote:
          "Grant the access above to the configured responsible, then Geetorus retries automatically.",
      };
