...
export const AGENT_ORDER_UPDATED_EVENT = "geetorus:agent-order-updated";
export const AGENT_SORT_MODE_UPDATED_EVENT = "geetorus:agent-sort-mode-updated";
const AGENT_ORDER_STORAGE_PREFIX = "geetorus.agentOrder";
const AGENT_SORT_MODE_STORAGE_PREFIX = "geetorus.agentSortMode";
