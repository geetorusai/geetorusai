import { checkOAuthEndpointUrl, oauthEndpointUrlRejectionMessage } from "@geetorusai/shared";
...
export function resolveAuthorizationTarget(value: string | null | undefined): AuthorizationTarget {
  ...
  const check = checkOAuthEndpointUrl(value ?? null, {
    ...
    // Geetorus's own origin: a first-party authorization endpoint (the smoke-lab
