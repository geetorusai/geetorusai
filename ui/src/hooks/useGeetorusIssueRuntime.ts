...
export interface GeetorusIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface GeetorusIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: GeetorusIssueRuntimeReassignment;
  attachmentIds?: string[];
}

interface UseGeetorusIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: GeetorusIssueRuntimeSendOptions) => Promise<void>;
...
export function useGeetorusIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseGeetorusIssueRuntimeOptions) {
