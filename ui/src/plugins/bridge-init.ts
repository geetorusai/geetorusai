 ...
 *
 * This is placed on `globalThis.__geetorusPluginBridge__` and consumed by
...
declare global {
  ...
  var __geetorusPluginBridge__: PluginBridgeRegistry | undefined;
}
...
function PluginSdkIssuesList({
  ...
  projectId = null,
  filters,
  viewStateKey = "geetorus:plugin-issues-view",
  initialSearch,
  createIssueLabel,
 ...
 * on `globalThis.__geetorusPluginBridge__` so the plugin module loader
