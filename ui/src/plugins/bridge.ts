 ...
 * `useHostContext` from `@geetorusai/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__geetorusPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided Geetorus path to the active company scope.
 *
