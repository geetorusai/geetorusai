...
const storybookRepoRoot = "~/geetorus";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.geetorus/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.geetorus/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Geetorus product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    description: "Make Geetorus the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @geetorusai/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://geetorus-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".geetorus/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/geetorusData.ts`.",
  ].join("\n"),
...
export const storybookSecretProviderDiscoveryPreview: SecretProviderConfigDiscoveryPreviewResult = {
  ...
  warnings: ["Skipped 1 Geetorus-managed AWS secret from a different deployment namespace."],
  candidates: [
    {
      provider: "aws_secrets_manager",
      displayName: "AWS production",
      ...
      samples: [
        {
          name: "geetorus/prod-use1/company-storybook/openai_api_key",
          hasKmsKey: true,
          tagKeys: ["geetorus:managed-by", "geetorus:environment", "geetorus:provider-owner"],
        },
      ],
      signals: {
        namespace: "prod-use1",
...
export const storybookSecrets: CompanySecret[] = [
  ...
  },
  {
    ...
    externalRef: "arn:aws:secretsmanager:us-east-1:123456789012:secret:geetorus/prod/aws-deploy-AbCdEf",
    providerConfigId: null,
    providerMetadata: null,
    latestVersion: 2,
...
export const storybookSecretBindings: CompanySecretBinding[] = [
  ...
  },
  {
    ...
    versionSelector: "latest",
    required: true,
    label: "Geetorus App project env",
    projectionClass: "unclassified",
    projectionAllowlistKey: null,
    createdAt: new Date("2026-03-02T09:00:00.000Z"),
    updatedAt: new Date("2026-03-02T09:00:00.000Z"),
  ...
  providers: [
    {
      ...
      warnings: [] as string[],
      backupGuidance: ["Backup ~/.geetorus/instances/default/secrets/key separately from the database."],
    },
    {
