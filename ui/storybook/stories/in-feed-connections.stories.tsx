...
import { CONNECTABLE_APP_DEFINITIONS, type ConnectionIntentInteraction, type ToolConnection } from "@geetorusai/shared";
...
const connection = {
  ...
  connectionKind: "managed", connectionPurpose: "tool", ownership: "customer", credentialSource: "geetorus_vault",
...
const meta: Meta = {
  ...
  beforeEach: ({ parameters }) => {
    ...
    window.fetch = async (input, init) => {
      ...
      if (url.pathname.endsWith("/agents")) return Response.json([{ id: pending.payload.requestingAgentId, companyId: pending.companyId, name: pending.payload.requestingAgentName, status: "active", adapterType: "geetorus_runner", role: "researcher" }]);
