...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@geetorusai/shared";
import type {
...
import { createIssue } from "../fixtures/geetorusData";
    ...
    <div className="geetorus-story">
      <main className="geetorus-story__inner space-y-6">
        <section className="geetorus-story__frame p-6">
          <div className="geetorus-story__label">Language</div>
