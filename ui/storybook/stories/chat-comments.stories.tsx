...
import type { Agent, FeedbackVote, IssueComment } from "@geetorusai/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/geetorusData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Geetorus work: checkout, comments, linked runs, and review feedback.\n\nFlaky CI lives in https://github.com/acme/web/pull/242 — re-running. Plain control link: https://random.example.com/path stays undecorated.",
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <div className="space-y-5">
          ...
          <ScenarioCard
            ...
            description="Issue is in planning mode. The composer turns amber and surfaces a Planning chip next to the geetorus — clicking it stages a Standard submission without immediately changing the issue mode."
          >
            <IssueChatThread
              comments={[]}
              timelineEvents={[]}
...
function IssueThreadNoticeReview() {
  return (
    <div className="geetorus-story">
      <main className="geetorus-story__inner max-w-4xl">
...
function CompactRecoveryNoticeReview() {
  return (
    <div className="geetorus-story">
      <main className="geetorus-story__inner max-w-4xl space-y-6">
...
function ChatCommentsStories() {
  return (
    <div className="geetorus-story">
      <main className="geetorus-story__inner space-y-6">
        <section className="geetorus-story__frame p-6">
          <div className="geetorus-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Geetorus operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="geetorus-story">
      <main className="geetorus-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
