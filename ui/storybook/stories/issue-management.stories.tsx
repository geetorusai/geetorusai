...
import type { Issue, IssueLabel, Project } from "@geetorusai/shared";
...
function IssuePropertiesRelationshipBadgesPane({ inline = false }: { inline?: boolean }) {
  ...
  return (
    <LongValueStorybookData>
      <div className="geetorus-story flex flex-wrap items-start gap-6 p-6">
...
function IssuePropertiesMobileBlockerActionsPane() {
  ...
  return (
    <StorybookData>
      <div ref={rootRef} className="geetorus-story min-h-screen p-4">
        ...
        <main className="geetorus-story__inner space-y-6">
          <section className="geetorus-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="geetorus-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="geetorus-story__frame shadow-none">
                  <CardHeader>
