...
function IntegratedSurface({
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="geetorus-doc-annotation-integrated mx-auto max-w-[1320px] p-4">
              ...
              <div className="mt-3 space-y-3">
                ...
                >
                  <MarkdownEditor
                    ...
                    contentClassName="geetorus-edit-in-place-content min-h-[220px] text-[15px] leading-7"
                  />
                </IssueDocumentAnnotations>
