...
import type { Agent } from "@geetorusai/shared";
import {
  storybookAgents,
  ...
  storybookIssues,
  storybookProjects,
} from "../fixtures/geetorusData";

const COMPANY_ID = "company-storybook";
const SELECTED_COMPANY_STORAGE_KEY = "geetorus.selectedCompanyId";
const ISSUE_DRAFT_STORAGE_KEY = "geetorus:issue-draft";

const storybookGoals: Goal[] = [
  {
    id: "goal-company",
    companyId: COMPANY_ID,
    title: "Build Geetorus",
...
const closeReadinessReady: ExecutionWorkspaceCloseReadiness = {
  ...
  plannedActions: [
    ...
    },
    {
      ...
      command: "git worktree remove .geetorus/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
    },
    {
      kind: "archive_record",
  ...
  git: {
    repoRoot: "/Users/dotta/geetorus",
    workspacePath: "/Users/dotta/geetorus/.geetorus/worktrees/PAP-1641-create-super-detailed-storybooks-for-our-project",
...
function ProjectDialogOpener({ populated }: { populated?: boolean }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      fillFirstField("input[placeholder='https://github.com/org/repo']", "https://github.com/geetorusai/geetorus");
      fillFirstField("input[placeholder='/absolute/path/to/workspace']", "/Users/dotta/geetorus/ui");
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Open-state stories for Geetorus creation dialogs, workspace confirmations, document diffing, image attachments, and path helper modals.",
      },
    },
  },
} satisfies Meta;
