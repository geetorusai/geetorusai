...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/geetorusData";
...
function SearchStories() {
  return (
    <div className="geetorus-story">
      <main className="geetorus-story__inner max-w-[1320px] space-y-6">
        <section className="geetorus-story__frame p-6">
          <div className="geetorus-story__label">Search</div>
        ...
        <section className="geetorus-story__frame overflow-hidden">
          <div className="geetorus-story__title-block">
            <div className="geetorus-story__label">/search</div>
        ...
        <section className="geetorus-story__frame overflow-hidden">
          <div className="geetorus-story__title-block">
            <div className="geetorus-story__label">/search · screen 3</div>
        ...
        <section className="geetorus-story__frame overflow-hidden">
          <div className="geetorus-story__title-block">
            <div className="geetorus-story__label">/search · screen 1</div>
        ...
        <section className="geetorus-story__frame overflow-hidden">
          <div className="geetorus-story__title-block">
            <div className="geetorus-story__label">/search · screen 4</div>
        ...
        <section className="geetorus-story__frame overflow-hidden p-4">
          <div className="geetorus-story__title-block">
            <div className="geetorus-story__label">Match-source chips</div>
        ...
        <section className="geetorus-story__frame overflow-hidden p-4">
          <div className="geetorus-story__title-block">
            <div className="geetorus-story__label">Cmd+K palette</div>
        ...
        <section className="geetorus-story__frame overflow-hidden p-4">
          <div className="geetorus-story__title-block">
            <div className="geetorus-story__label">Search result row</div>
