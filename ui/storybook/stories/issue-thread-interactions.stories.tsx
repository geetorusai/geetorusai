...
import type { GeetorusQuestionResponse, GeetorusQuestionSet } from "@geetorusai/adapter-utils";
...
import { storybookAgentMap } from "../fixtures/geetorusData";
...
const composerQuestions: GeetorusQuestionSet = {
...
function InteractiveComposerQuestions() {
  const [response, setResponse] = useState<GeetorusQuestionResponse | null>(null);
    ...
    <StoryFrame>
      <Section eyebrow="Connection intent" title="Inline setup request states">
        <div className="grid gap-6 xl:grid-cols-2">
          ...
          <ScenarioCard
            title="Other viewer"
            description="Other viewers see who Geetorus is waiting for and receive no connection controls."
          >
            <IssueThreadInteractionCard
              interaction={pendingConnectionIntentInteraction}
              agentMap={storybookAgentMap}
  ...
  render: () => (
    <StoryFrame>
      <section className="geetorus-story__frame p-6">
        <div className="geetorus-story__label">Thread interactions</div>
