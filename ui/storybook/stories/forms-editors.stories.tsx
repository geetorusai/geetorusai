...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@geetorusai/shared";
...
import { createIssue, storybookAgents } from "../fixtures/geetorusData";
...
function Section({
  ...
  return (
    <section className="geetorus-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="geetorus-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="geetorus-story">
      <main className="geetorus-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/geetorusai/geetorus).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Geetorus secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @geetorusai/ui typecheck", "pnpm build-storybook"],
...
const routineVariables: RoutineVariable[] = [
  {
    ...
    label: "Repository",
    type: "text",
    defaultValue: "geetorusai/geetorus",
    required: true,
    options: [],
  },
  {
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Geetorus" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    defaultRef: "master",
    repoName: "geetorus",
    localFolder: "/Users/dotta/geetorus",
    managedFolder: "geetorus",
    effectiveLocalFolder: "/Users/dotta/geetorus",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="geetorus-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="geetorus-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Geetorus form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Geetorus form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
