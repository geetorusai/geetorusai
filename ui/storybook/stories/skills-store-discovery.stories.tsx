...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    key: "geetorusai/geetorus/geetorus-dev",
    skillId: "s-dev",
    catalogRef: null,
    name: "geetorus-dev",
    slug: "geetorus-dev",
    author: "Geetorus",
    version: "v2.4.1",
    tagline: "Run and repair local Geetorus workspaces.",
    description: "Develop and operate a local Geetorus instance.",
  ...
  {
    key: "geetorusai/geetorus/verify",
    skillId: "s-verify",
    catalogRef: null,
    name: "verify",
    slug: "verify",
  ...
  {
    key: "geetorusai/geetorus/security-review",
    skillId: "s-sec",
    catalogRef: null,
  ...
  {
    key: "geetorusai/geetorus/diagnose-why-work-stopped",
    skillId: "s-diag",
    catalogRef: "c-diag",
