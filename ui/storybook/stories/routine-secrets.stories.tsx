...
import { storybookCompanies, storybookSecrets } from "../fixtures/geetorusData";

const COMPANY_ID = "company-storybook";

if (typeof window !== "undefined") {
  window.localStorage.setItem("geetorus.selectedCompanyId", COMPANY_ID);
}
    ...
    <Card className="w-full max-w-2xl">
      ...
      <CardContent className="space-y-3">
        <p className="text-xs text-muted-foreground">
          ...
          project and agent env. <span className="font-mono">GEETORUS_*</span> variables are reserved.
        </p>
