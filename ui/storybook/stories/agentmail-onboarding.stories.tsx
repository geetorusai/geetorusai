...
import type { AgentPermissions } from "@geetorusai/shared";
...
import { storybookAgents } from "../fixtures/geetorusData";
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            {lowTrust
              ...
              : "Email can contain malicious instructions. We recommend Low-trust review to limit the agent’s access to Geetorus work."}
          </p>
        </div>
      </div>
    ...
    <QueryClientProvider client={client}>
                        ...
                        <RadioCardGroup
                          ...
                          options={[
                            ...
                            },
                            {
                              ...
                              title: "Webhook",
                              description:
                                "For a Geetorus server with a public HTTPS address.",
                            },
                          ]}
                        />
                        {receiveMode === "webhook" && (
                          <p className="text-xs text-muted-foreground">
                            Geetorus registers and verifies the webhook at your
      ...
      <Dialog open={trustDialog} onOpenChange={setTrustDialog}>
        <DialogContent className="max-h-screen overflow-y-auto sm:max-w-2xl">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Low trust limits Geetorus access; it does not sandbox the runtime.
