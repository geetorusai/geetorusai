...
function StateMatrix() {
  return (
    <div className="geetorus-story space-y-8">
...
function inlineMarkdownStory() {
  ...
  return (
    <div className="geetorus-story space-y-4 text-sm">
...
function projectsRollupStory() {
  ...
  const projects = [
    { name: "Geetorus App", color: "#6366f1", summary: summary({ failed: 3, running: 12 }) },
  ...
  return (
    <div className="geetorus-story w-72 rounded border border-border bg-background p-2">
...
function StateMatrixStory() {
  return (
    <div className="geetorus-story space-y-12 p-6">
      <StateMatrix />
      {inlineMarkdownStory()}
      {relatedWorkStory()}
      {projectsRollupStory()}
...
function PropertiesPanelDesktop() {
  ...
  return (
    <div className="geetorus-story w-[420px] rounded-lg border border-border bg-background/70 p-4">
...
function PropertiesPanelMobile() {
  const issue = storybookIssues[0]!;
  return (
    <div className="geetorus-story mx-auto w-[358px] rounded-lg border border-border bg-background/70 p-3">
      <div className="mb-3 text-xs uppercase tracking-wide text-muted-foreground">
...
function RelatedWorkEmptyDesktop() {
  return (
    <div className="geetorus-story space-y-3 p-6">
...
function SidebarMobileDrawer() {
  ...
  return (
    <div className="geetorus-story mx-auto w-[320px] rounded border border-border bg-background p-2">
      <div className="mb-2 text-xs uppercase tracking-wide text-muted-foreground">Projects (mobile drawer)</div>
      <ul className="flex flex-col">
        {[
          { name: "Geetorus App", color: "#6366f1", summary },
...
function IssueListWithBadge() {
  const summary = makeIntegrationSummary();
  return (
    <div className="geetorus-story p-6">
      <div className="mb-3 text-xs uppercase tracking-wide text-muted-foreground">
...
function FilterPopoverWithExternalChecked() {
  ...
  return (
    <div className="geetorus-story flex min-h-[640px] items-start justify-end p-6">
      <div ref={triggerRef}>
        <IssueFiltersPopover
          state={state}
...
function IntegrationSurfacesStory() {
  return (
    <div className="geetorus-story space-y-10 p-6">
