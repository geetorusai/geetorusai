...
import { ManagedOAuthHandoffState } from "@/pages/apps/GeetorusCloudOAuthHandoff";
...
export const RetryAfterInfrastructureFailure: Story = {
  args: {
    phase: "error",
    error: "Geetorus Cloud couldn’t prepare secure sign-in. Try again.",
  },
};
...
export const TerminalExpiredSession: Story = {
  args: {
    phase: "error",
    error: "This sign-in expired. Return to Geetorus and start the connection again.",
  },
};
