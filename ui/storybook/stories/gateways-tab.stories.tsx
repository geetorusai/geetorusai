...
import type { ToolMcpGatewayWithTokens } from "@geetorusai/shared";
    ...
    clientSnippets: [
      {
        ...
        config: {
          mcpServers: {
            "geetorus-engineering-inbox": {
              url: "https://geetorus.app/api/mcp/gateways/engineering-inbox",
    ...
    clientSnippets: [
      {
        ...
        config: {
          mcpServers: {
            "geetorus-support-ops": {
              url: "https://geetorus.app/api/mcp/gateways/support-ops",
              headers: { Authorization: "Bearer YOUR_TOKEN" },
            },
          },
        },
