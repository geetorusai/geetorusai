...
function resetFixture(scenario: Scenario) {
  ...
  if (scenario.screen === "task") {
    principal = { ...sender, status: "linked", geetorusUserLabel: "Alex" };
    simulateIncoming();
  }
  ...
  return <div className="mx-auto max-w-4xl space-y-6 p-4">
    <aside className="space-y-2 rounded-lg border border-border bg-muted p-3 text-sm">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button size="sm" variant="outline" onClick={() => { principal = { ...sender, status: "linked", geetorusUserLabel: "Alex" }; refresh(); }}>Simulate identity confirmation</Button>
