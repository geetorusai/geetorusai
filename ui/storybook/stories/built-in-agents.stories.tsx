...
const briefsAgent: Agent = {
  ...
  metadata: { geetorusBuiltInAgent: { key: "briefs", featureKeys: ["briefs"] } },
  ...
  render: () => (
    <div className="mx-auto max-w-3xl space-y-8 p-6">
      ...
      <div className="space-y-3">
        ...
        >
          Ships with Geetorus and powers <strong>Briefs</strong>. Configure it like any agent —
...
const reflectionDefinition = {
  ...
  defaultInstructions: "You are Geetorus's built-in Reflection Coach.",
  defaultRole: "general",
