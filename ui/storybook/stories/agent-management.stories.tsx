...
import { storybookAgents, storybookIssues } from "../fixtures/geetorusData";
...
const agentManagementAgents: Agent[] = [
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        GEETORUS_TRACE: { type: "plain", value: "storybook" },
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "geetorus-storybook", priority: "normal" }, null, 2),
      env: {
...
const storybookSecrets: CompanySecret[] = [
    ...
    createdAt: recent(12_000),
	  ...
	  },
	  {
	    ...
	    ownerUserId: null,
	    userSecretDefinitionId: null,
	    key: "/geetorus-cloud/prod/database/url",
	    name: "/geetorus-cloud/prod/database/url",
	    provider: "local_encrypted",
	    status: "active",
	    managedMode: "geetorus_managed",
	    externalRef: null,
        ...
        <main className="geetorus-story__inner space-y-6">
          <section className="geetorus-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="geetorus-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended Geetorus fixtures.",
      },
    },
  },
...
const managedKubernetesEnvironment: Environment = {
  ...
  envVars: {},
  metadata: { managedByGeetorus: true, managedKubernetesSandbox: true },
...
function ForcedKubernetesFixtures({
  ...
  // the managed Kubernetes sandbox (GEETORUS_EXECUTION_MODE=kubernetes).
