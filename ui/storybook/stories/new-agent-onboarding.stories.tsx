...
const meta = {
  ...
  argTypes: {
    ...
    initialAdapter: { control: "select", options: [null, "claude_local", "codex_local", "cursor", "cursor_cloud", "gemini_local", "grok_local", "kimi_local", "opencode_local", "pi_local", "hermes_local", "geetorus_runner"] },
  },
...
export const RunnerAcpxClaude: Story = { name: "Runner · ACPX with Claude", args: { initialScreen: "runtime", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "Claude (ACPX)" } };
export const RunnerOpenCode: Story = { name: "Runner · OpenCode", args: { initialScreen: "runtime", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "OpenCode" } };

export const NativeCodexRunner: Story = { name: "Runner · Native Codex app server", args: { initialScreen: "runtime", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "Codex (app server)" } };
...
export const ClaudeRunnerApiKey: Story = { name: "Connect · Claude runner · API key", args: { initialScreen: "connect", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "Claude (ACPX)", initialConnectionMethod: "api" } };
export const CodexRunnerApiKey: Story = { name: "Connect · Native Codex runner · API key", args: { initialScreen: "connect", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "Codex (app server)", initialConnectionMethod: "api" } };
...
export const ClaudeRunnerSubscription: Story = { name: "Connect · Claude runner · Subscription", args: { initialScreen: "connect", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "Claude (ACPX)", initialConnectionWaiting: true } };
export const CodexRunnerSubscription: Story = { name: "Connect · Native Codex runner · Subscription", args: { initialScreen: "connect", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "Codex (app server)", initialConnectionWaiting: true } };
...
export const CodexConfirmation: Story = { name: "Confirmation · Native Codex runner", args: { initialScreen: "saved", initialName: "Darnold", initialAdapter: "geetorus_runner", initialRunnerProvider: "Codex (app server)" } };
