...
import { APP_DEFINITIONS, getAppStoreDefinition, type AppDefinition, type ToolApplication, type ToolConnection, type ConnectionGrantsResponse } from "@geetorusai/shared";
...
function asConnection(account: AiConnectionSummary): ToolConnection {
  return {
    ...
    credentialSource: "geetorus_vault", credentialPolicy: account.ownership === "shared" ? "shared" : "per_user",
