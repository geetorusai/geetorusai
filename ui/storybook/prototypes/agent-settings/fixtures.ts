...
export function createSettingsFixtures(
  ...
  let desiredSkills = ["geetorus", "design-guide"];
  const files: Record<string, string> = {
    ...
    "references/product.md":
      "# Product context\n\nGeetorus helps people coordinate teams of agents. Prefer simple workflows with visible progress.\n",
  };
          ...
          return json(
            url.pathname.includes("claude")
              ...
              : url.pathname.includes("codex") ||
                  url.pathname.includes("geetorus_runner")
                ? codexModels
