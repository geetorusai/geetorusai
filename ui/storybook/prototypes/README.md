...
```sh
pnpm --filter @geetorusai/ui exec storybook dev --port 6010 --host 127.0.0.1 --no-open -c storybook/.storybook
```
...
Geetorus Runner has exactly three choices, selected before creation:
...
Additional runtime stories cover Codex, OpenCode, Pi, and Geetorus Runner, plus
