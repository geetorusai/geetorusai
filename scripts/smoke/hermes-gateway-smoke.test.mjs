...
GEETORUS_API_KEY="geetorus-secret"
GEETORUS_AUTH_HEADER="Bearer board-secret"
GEETORUS_COOKIE="session=board-cookie"
output="$(redact_text "gateway-secret claim-secret agent-secret geetorus-secret Bearer board-secret session=board-cookie")"
[[ "$output" != *"gateway-secret"* ]]
[[ "$output" != *"claim-secret"* ]]
[[ "$output" != *"agent-secret"* ]]
[[ "$output" != *"geetorus-secret"* ]]
[[ "$output" != *"board-secret"* ]]
[[ "$output" != *"board-cookie"* ]]
