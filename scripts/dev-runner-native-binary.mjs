...
export function geetorusRunnerBinaryNeedsBuild({
  repoRoot,
  ...
  const executable = platform === "win32" ? "geetorus-runnerd.exe" : "geetorus-runnerd";
  const packageRoot = path.join(repoRoot, "packages", "geetorus-runner");
