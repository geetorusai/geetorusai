...
const STORIES = [
  {
    id: "geetorus-source-issue-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "geetorus-source-issue-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "geetorus-source-issue-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "geetorus-source-issue-recovery--active-run-panel-recovery-chips",
