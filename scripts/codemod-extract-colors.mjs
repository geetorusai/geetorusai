...
const ALLOWLIST_COMMENTS = [
  ...
  },
  {
    ...
    anchor: 'isHighlighted && "bg-[var(--geetorus-code-highlight-bg,rgba(250,204,21,0.12))]",',
    commentLine: "                // token-extraction: allowlisted — half-migrated var(--x, fallback) pattern; --geetorus-code-highlight-bg/-border don't exist in index.css yet. Needs human decision (see TOKEN-AUDIT.md 2) before minting, since defining the var changes a fallback-CSS-var-expression, not a plain literal swap.",
  },
  {
    file: "pages/InviteUxLab.tsx",
