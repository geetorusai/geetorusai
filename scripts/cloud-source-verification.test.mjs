...
const baseRun = {
  ...
  repository: { full_name: "geetorusai/geetorus" }, head_repository: { full_name: "geetorusai/geetorus" },
...
test("only the expected workflow, repository, master push, and full SHA can supply proof", async () => {
  for (const overrides of [
    ...
    { repository: { full_name: "other/geetorus" } }, { head_repository: { full_name: "fork/geetorus" } },
