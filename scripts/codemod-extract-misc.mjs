...
function registerResolvedVarToken(varName, fallbackRaw, sourceNote) {
  // varName like "--geetorus-code-highlight-bg" -> token name
  // "code-highlight-bg-resolved" (strip the leading "--geetorus-" prefix
  ...
  const bare = varName.replace(/^--geetorus-/, "").replace(/^--/, "");
