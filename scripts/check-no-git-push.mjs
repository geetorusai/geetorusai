 ...
 *
 * Opt-in mechanism: a line containing `geetorus:allow-git-push` (typically
 * inside a `// geetorus:allow-git-push: <reason>` comment on the line itself
...
export const ALLOW_MARKER = "geetorus:allow-git-push";
