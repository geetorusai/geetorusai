...
SYSTEMS = {
    "runner": ("runner-protocol-evals", "geetorus.runner-protocol-eval.history/v1"),
    "product": ("runner-e2e", "geetorus.runner-e2e.history/v1"),
}
...
def main():
    ...
    values["guide_url"] = "https://github.com/geetorusai/geetorus/blob/" + quote(args.docs_ref, safe="/") + "/doc/evals.md"
