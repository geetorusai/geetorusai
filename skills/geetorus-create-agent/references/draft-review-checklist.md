...
- [ ] The first paragraph points at the Geetorus skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Geetorus execution contract verbatim:
...
- [ ] Adapter config matches this Geetorus instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
