...
This note inventories the Geetorus issues that point to the same UX class of problem:
...
Pattern: Geetorus already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
