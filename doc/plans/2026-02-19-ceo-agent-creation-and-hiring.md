...
- installed adapter list for this Geetorus instance
...
## 8. New Skill: `geetorus-create-agent`

Create new skill directory:

- `skills/geetorus-create-agent/SKILL.md`
- `skills/geetorus-create-agent/references/api-reference.md`
...
Also update `skills/geetorus/SKILL.md` to reference this skill for hiring workflows.
...
- `geetorus-create-agent` skill + docs updates
