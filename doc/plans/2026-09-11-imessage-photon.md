...
Sender enrollment in Photon and identity linking in Geetorus are separate gates.
...
work without a mention. Require linked Geetorus people by default. Unlinked
...
enable it in Geetorus, send a fresh authorized request.
...
metadata, bytes, time and decoded dimensions. Keep Geetorus's configured limits,
