export const providerScreens = [
  {
    ...
    rationale: "Geetorus generates the exact provider handoff while keeping Slack-owned installation and workspace policy visible.",
    annotations: [
      "The selected Geetorus agent and derived Slack bot identity stay fixed throughout setup.",
      ...
      "Secrets are masked references; workspace install or OAuth happens in Slack, not inside a Geetorus imitation.",
  ...
  },
  {
    ...
    annotations: [
      ...
      "Root mention → Slack thread → one Geetorus issue is fixed; bound-thread replies continue without mentions.",
  ...
  },
  {
    ...
    title: "Slack interaction model", subtitle: "A root mention moves the work into one native thread and one Geetorus issue.",
    ...
    annotations: [
      ...
      "Geetorus durably records and acknowledges the event before task work begins.",
      "Maya replies under the activation message; that Slack thread binds exactly one assigned Geetorus issue.",
  ...
  },
  {
    ...
    annotations: [
      ...
      "Geetorus provides the webhook URL/secret and the minimum Issues, Pull requests, and Metadata permissions.",
  ...
  },
  {
    ...
    annotations: [
      "The Geetorus repository allowlist can only narrow the repositories selected in the GitHub App installation.",
      ...
      "Output uses GFM, reactions, and coarse comment edits; files and governed actions become Geetorus links.",
  ...
  },
  {
    ...
    title: "GitHub interaction model", subtitle: "A mention binds the existing issue, PR, or review thread to one Geetorus issue.",
    rationale: "GitHub supplies the conversation object, so Geetorus binds it rather than manufacturing a new native thread.",
    annotations: [
      ...
      "The existing GitHub object/thread maps once to a Geetorus issue; an inline review thread remains separate from the PR conversation.",
      "Maya reacts, posts or edits one GFM progress comment, and publishes the final answer without token streaming.",
      "Buttons, modals, ephemeral replies, DMs, and uploads fall back to text plus authenticated Geetorus URLs."
    ]
  },
  {
    ...
    annotations: [
      "Geetorus fixes Maya and supplies the public messaging endpoint before the operator enters Microsoft tooling.",
  ...
  },
  {
    ...
    annotations: [
      "Personal, team/channel, and group-chat reach is bounded by app installation and Geetorus allowlists.",
  ...
  },
  {
    ...
    annotations: [
      ...
      "Geetorus verifies the bot activity, resolves tenant/member identity, and applies current access before waking Maya.",
  ...
  },
  {
    ...
    annotations: [
      "One BotFather bot represents one Geetorus agent; name, username, avatar, and token come from Telegram.",
      ...
      "Geetorus supplies the HTTPS webhook URL and secret token, while the operator adds the bot to intended chats.",
  ...
  },
  {
    ...
    annotations: [
      ...
      "Geetorus deduplicates update_id, enforces actor/chat scope, then uses typing/reaction and throttled output.",
      "Inline callbacks carry opaque IDs; unsupported or governed interactions return concise text/DM plus a Geetorus link."
    ]
  }
];
