export const permissionModel = [
  ...
  [
    "Geetorus enablement",
    "Geetorus responds only in provider resources that a Geetorus administrator has enabled for this connection. Invitation or installation alone is not permission to create a task."
  ],
  [
    "Effective reach",
    "A message is eligible only when the provider delivers it, its resource is enabled in Geetorus, the connection is active, and the sender has authority for the requested action."
  ],
  [
    "Safe default",
