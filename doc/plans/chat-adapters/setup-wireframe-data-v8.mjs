  ...
  screens: [
    {
      ...
      subtitle:
        "Bring your own dedicated GitHub App and verify it with Geetorus.",
      ...
      instructions: [
        [
          ...
          "Geetorus stores a random 32-byte secret and shows it once. Paste it with the Geetorus webhook URL into GitHub and keep SSL verification enabled.",
        ],
        [
        ...
        [
          ...
          "Paste the numeric App ID and private-key PEM into Geetorus. Connect remains unavailable until GitHub has delivered a correctly signed webhook ping.",
        ],
      ],
      values: [
        [
          "Geetorus webhook URL",
          "https://geetorus.example/api/chat-webhooks/…/github",
        ],
        ["Webhook secret", "Generated by Geetorus · shown once"],
      ],
      fields: [
      ...
      annotations: [
        ...
        "Geetorus generates the webhook secret and never returns it from normal endpoint reads.",
        ...
        "GitHub installation scope and Geetorus repository enablement remain independent reach controls.",
      ],
      rationale:
        "Bring-your-own App credentials are sufficient to ship and preserve one provider bot identity per Geetorus agent.",
    },
    {
      id: "46",
      slug: "github-try",
      ...
      actions: [
        [
          "Open GitHub",
          "Opens an installed repository while Geetorus waits for the first signed mention and follow-up to complete setup.",
        ],
      ],
      annotations: [
        ...
        "One external conversation maps to one Geetorus task.",
      ],
      rationale:
  ...
  screens: [
    {
      ...
      instructions: [
        [
          ...
          "Use Geetorus's public callback in the Azure Bot configuration.",
        ],
        [
        ...
        [
          ...
          "Paste the Application ID, Directory/Tenant ID, and client-secret value into Geetorus.",
        ],
      ],
      actions: [
        [
      ...
      annotations: [
        "Geetorus provides the exact public messaging endpoint.",
    ...
    },
    {
      ...
      annotations: [
        ...
        "Geetorus does not generate a complete Teams package or promise an install link.",
    ...
    },
    {
      ...
      instructions: [
        ...
        [
          "Continue in replies",
          "Reply once beneath that post; the post and replies are one Geetorus task.",
        ],
      ],
      actions: [
        [
          "Open Microsoft Teams",
          "Opens Teams while Geetorus waits for the authenticated mention and reply.",
        ],
      ],
      annotations: [
    ...
    },
    {
      ...
      instructions: [
        ...
        [
          ...
          "Create the Azure Bot, configure Geetorus's endpoint, and create the customer-owned Teams app in Developer Portal.",
        ],
        [
          "Enter the identity below",
          "Return the Application ID, Directory ID, and client-secret value to Geetorus.",
        ],
      ],
      actions: [
        [
          "Copy Geetorus endpoint",
      ...
      annotations: [
        "The endpoint is the one Geetorus-specific value required by Microsoft.",
        "Every instruction is a provider portal operation.",
        "The three identity fields are the minimum credentials Geetorus needs.",
