...
const sharedAnnotations = {
  overview: [
    "The endpoint keeps one Geetorus agent and one provider-native bot identity together.",
  ...
  access: [
    ...
    "Linked provider identities act as their current Geetorus users and retain ordinary permission checks.",
  ...
  conversations: [
    "Each row names the provider-native conversation boundary and its single Geetorus issue.",
...
export const providers = [
  {
    ...
    setupSections: [
      { title: "Agent and Slack identity", intro: "This endpoint represents exactly one Geetorus agent.", rows: [
        ["Geetorus agent", "Maya · Support engineer", "Change agent"],
        ["Slack bot", "Maya · @maya · avatar preview", "Preview"]
      ]},
      { title: "Choose delivery", intro: "Geetorus generates the callback address before the Slack app is created.", rows: [
        ["Recommended", "Direct signed webhook for cloud or public self-hosted Geetorus.", "Direct webhook"],
        ["Private Geetorus", "Use the outbound authenticated relay when this instance is not publicly reachable.", "Use relay"],
      ...
      { title: "Connect credentials", intro: "Geetorus stores secret references, never raw values in endpoint configuration.", rows: [
    ...
    setupAnnotations: [
      "Agent and native bot identity are the first and only Geetorus binding decision.",
      "Direct webhook is the default; relay and Socket Mode are explicit deployment alternatives.",
      "Geetorus provides a manifest, while Slack owns app creation, approval, installation, and channel invitation.",
    ...
    overviewSections: [
      ...
      { title: "Available automatically", intro: "Geetorus always uses the richest safe Slack behavior permitted by this installation.", rows: [
    ...
    settingsSections: [
      { title: "Conversation reach", intro: "Geetorus can narrow reach but cannot exceed Slack installation and channel membership.", rows: [
      ...
      { title: "Task boundaries", intro: "Slack's native thread is the task boundary for channel work.", rows: [
        ["New channel work", "A root @maya mention creates the Slack thread and one Geetorus issue.", "Fixed"],
      ...
      { title: "Security and delivery", intro: "Geetorus reports the deployment-selected path; it is not an endpoint setting.", rows: [
    ...
    accessSections: [
      ...
      { title: "Linked Slack people", intro: "Linked identities act as their mapped Geetorus users.", rows: [
  ...
  },
  {
    ...
    setupSections: [
      { title: "Agent and GitHub identity", intro: "This chat endpoint is separate from any GitHub code/tool connection.", rows: [
        ...
        ["GitHub App identity", "geetorus-maya[bot] · avatar preview", "Preview"]
      ]},
      ...
      { title: "Create the GitHub App", intro: "Geetorus supplies exact webhook and least-privilege permission values.", rows: [
      ...
      { title: "Install on repositories", intro: "GitHub owns organization approval and repository selection.", rows: [
        ...
        ["3. Add credentials", "App ID and private key are stored as Geetorus secret references.", "Add secrets"]
      ]},
    ...
    setupAnnotations: [
      ...
      "Geetorus gives the operator exact webhook, permission, and event values in one vertical sequence.",
      "GitHub owns organization approval and repository selection; Geetorus stores only secret references.",
    ...
    overviewSections: [
      { title: "Connection", intro: "One GitHub App bot represents Maya in the selected installation.", rows: [
        ...
        ["Agent", "Maya · Support engineer", "Open agent"],
        ["GitHub identity", "geetorus-maya[bot] · Acme installation", "Open GitHub"]
      ]},
      ...
      { title: "Available automatically", intro: "Geetorus uses every safe interaction GitHub exposes for this chat connection.", rows: [
        ...
        ["Files and actions", "Ingest safe linked attachments; publish artifacts and governed actions as Geetorus links.", "Included"],
    ...
    settingsSections: [
      { title: "Repository reach", intro: "Geetorus can only narrow repositories selected in the GitHub App installation.", rows: [
      ...
      { title: "Task boundaries", intro: "GitHub's existing object or review thread is the durable conversation boundary.", rows: [
        ["Activation", "A direct @geetorus-maya mention binds the addressed conversation.", "Mention"],
    ...
    accessSections: [
      ...
      { title: "Linked GitHub people", intro: "The durable GitHub numeric user ID is linked after Geetorus authentication.", rows: [
    ...
    activityRows: [
      ...
      ["Inbound delivery", "3b129 · geetorus-maya[bot] self comment", "Suppressed · 8m"],
  ...
  },
  {
    ...
    setupSections: [
      { title: "Agent and Teams identity", intro: "One Teams bot application represents exactly one Geetorus agent.", rows: [
        ["Geetorus agent", "Maya · Support engineer", "Change agent"],
        ["Teams bot", "Maya · app and avatar preview", "Preview"],
        ["Messaging endpoint", "https://chat.geetorus.app/in/••••/teams", "Copy"]
      ]},
      ...
      { title: "Register and package the Teams app", intro: "Teams Developer CLI is the shortest supported handoff; manual registration remains available.", rows: [
        ...
        ["3. Download app package", "Geetorus validates scopes, IDs, endpoint, and package consistency.", "Download"]
      ]},
    ...
    setupAnnotations: [
      ...
      "Geetorus provides CLI, manifest, and package values in a conventional top-to-bottom handoff.",
      "Tenant approval and installation happen in Microsoft Teams; Geetorus keeps the draft if admin action is required.",
    ...
    overviewSections: [
      ...
      { title: "Available automatically", intro: "Geetorus uses the richest safe Teams behavior available in the current conversation scope.", rows: [
    ...
    settingsSections: [
      { title: "Tenant and conversation reach", intro: "Geetorus narrows the scopes where the Teams app is installed.", rows: [
  ...
  },
  {
    ...
    setupSections: [
      { title: "Agent and Telegram identity", intro: "One Telegram username represents exactly one Geetorus agent.", rows: [
        ["Geetorus agent", "Maya · Support engineer", "Change agent"],
      ...
      { title: "Choose delivery", intro: "Webhook and polling are mutually exclusive.", rows: [
        ...
        ["Private Geetorus", "Use the outbound relay to reach the same verified webhook handler.", "Use relay"],
        ["Local development", "One long-running poller; Geetorus removes any webhook first.", "Advanced"]
      ]},
      { title: "Connect token and chats", intro: "The bot token is a Geetorus secret reference and can be rotated independently.", rows: [
    ...
    overviewSections: [
      ...
      { title: "Available automatically", intro: "Geetorus uses every safe Telegram capability valid for the current chat type.", rows: [
    ...
    settingsSections: [
      ...
      { title: "BotFather policy and delivery", intro: "Geetorus reports the deployment-selected path; it is not an endpoint preference.", rows: [
        ["Delivery path", "Selected from instance reachability and verified continuously.", "Automatic"],
        ...
        ["Delivery changes", "Geetorus drains pending updates if instance delivery changes.", "Automatic"]
      ]}
    ],
    settingsAnnotations: [
    ...
    accessSections: [
      ...
      { title: "Telegram identity rules", intro: "Forwarded messages, anonymous admins, and bots require explicit handling.", rows: [
        ["Anonymous/forwarded actor", "Do not infer a Geetorus user when a stable sender identity is absent.", "Restricted"],
