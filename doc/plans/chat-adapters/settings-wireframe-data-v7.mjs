export const fixedBehavior = [
  [
    "Channel activation",
    "A root mention creates a provider-native thread and one Geetorus task on Slack and Teams. Replies in that thread continue the same task without another mention."
  ],
  [
    "Existing provider thread",
    "The first mention inside an unbound Slack or Teams thread binds that existing thread to one new Geetorus task. Earlier messages are not imported automatically."
  ],
  [
    "Direct messages",
  ...
  [
    ...
    "A mention binds the addressed issue, pull-request conversation, or inline review thread to one Geetorus task."
  ],
  [
  ...
  [
    "Delivery",
    "Geetorus chooses direct verified webhooks when reachable and the instance relay when private. This is deployment configuration, not an endpoint preference."
  ],
  [
    ...
    sections: [
      {
        ...
        intro: "Geetorus can narrow, but not exceed, the GitHub App installation.",
        items: [
