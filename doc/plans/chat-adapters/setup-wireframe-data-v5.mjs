    ...
    screens: [
      {
        ...
        subtitle:
          "Approve one agent installation. Geetorus handles credentials and delivery in the background.",
        ...
        groups: [
          {
            title: "Agent",
            intro:
              "This connection is permanently assigned to one Geetorus agent.",
          ...
          },
          {
            ...
            rows: [
              ...
              [
                "Installation",
                "Slack returns the authorized agent installation to this Geetorus company.",
                "Automatic return",
              ],
            ],
          },
          {
            title: "What Geetorus handles",
            intro:
              "No token, signing secret, webhook, relay, or Socket Mode choice appears in this path.",
            rows: [
              [
                "Credentials",
                "Store the returned Slack installation in Geetorus's secret store; never reveal it in connector settings.",
                "Automatic",
              ],
              [
                "Delivery",
                "Select and verify the correct callback path for this Geetorus deployment.",
                "Automatic",
              ],
              [
                "Capabilities",
        ...
        actions: [
          [
            "Add Maya to Slack",
            "Opens Slack's agent-installation authorization, then returns to Geetorus with the scoped installation stored internally.",
          ],
          [
      ...
      },
      {
        ...
        subtitle:
          "Mention Maya once. Geetorus verifies the real workspace event and creates the first task thread.",
        rail: ["Agent selected", "Add Maya to Slack", "Try Maya"],
        active: 2,
        mode: "default",
        groups: [
          ...
          },
          {
            ...
            rows: [
              ...
              [
                ...
                "Maya replies in a new thread; that thread is one Geetorus task.",
                "Expected",
              ],
            ],
          },
          {
            ...
            intro:
              "Geetorus waits for an actual signed Slack event rather than claiming setup works after a token check.",
            rows: [
              ["Workspace event", "No test mention received yet.", "Waiting"],
              [
                "If Maya is not in the channel",
                "Slack prompts you to add the agent; no Geetorus setting is required.",
                "Handled in Slack",
              ],
            ],
          },
        ...
        actions: [
          [
            "Open Slack",
            "Opens the installed workspace; Geetorus remains on this step and listens for the first valid event.",
          ],
          [
      ...
      },
      {
        ...
        groups: [
          ...
          {
            title: "Geetorus prepared the app",
            intro:
            ...
            rows: [
              ...
              [
                "Callback",
                "Chosen automatically for this Geetorus deployment.",
                "Prepared",
              ],
              [
                "Permissions",
        ...
        actions: [
          [
            ...
            "Opens Slack's app-from-manifest URL with Geetorus's generated manifest already encoded.",
          ],
          [
        ...
        annotations: [
          ...
          "Geetorus precomputes identity, callbacks, permissions, and events; none become user choices.",
          "One external action replaces the old manifest copy, delivery selection, and provider-configuration rows.",
        ],
        rationale:
          "A custom app remains possible, but Geetorus collapses it to the provider action that only the customer can perform.",
      },
      {
        id: "43",
        ...
        subtitle:
          "Provide only the two secrets Slack cannot return to Geetorus for a customer-owned app.",
        rail: ["Agent selected", "Create Slack app", "Connect app", "Verify"],
        active: 2,
        mode: "advanced",
        fields: [
        ...
        groups: [
          {
            ...
            intro:
              "Values are submitted once into Geetorus's secret store. Connector rows retain only secret references and redacted suffixes.",
            rows: [
              [
                "Who can view them",
        ...
        annotations: [
          ...
          "Help text explains exactly why Geetorus needs each secret.",
      ...
      },
      {
        ...
        subtitle:
          "Geetorus checks identity, callbacks, permissions, and installation before activation.",
        rail: ["Agent selected", "Create Slack app", "Connect app", "Verify"],
        active: 3,
        mode: "advanced",
        groups: [
          {
            ...
            rows: [
              ...
              [
                "Event subscriptions",
                "Mention, message, interaction, and command callbacks reach Geetorus.",
                "Passed",
              ],
            ],
          },
    ...
    screens: [
      {
        ...
        subtitle:
          "GitHub creates a dedicated App from Geetorus's manifest and returns its credentials automatically.",
        rail: [
          "Agent selected",
          "Create GitHub App",
          "Choose repositories",
        ...
        groups: [
          {
            title: "Agent",
            intro:
              "The GitHub App is permanently assigned to this Geetorus agent.",
            rows: [
              [
                "Maya",
          ...
          },
          {
            ...
            intro:
              "Geetorus submits an App Manifest; GitHub shows the owner and app-name confirmation.",
            rows: [
              [
                "App identity",
                "geetorus-maya[bot] · native mention and avatar",
                "Dedicated",
              ],
              [
                "Chat permissions",
          ...
          },
          {
            ...
            intro:
              "GitHub redirects with a one-time code that Geetorus exchanges within the provider deadline.",
            rows: [
              [
                "App ID and private key",
                "Stored directly in Geetorus's secret store.",
                "Automatic",
              ],
              [
                "Webhook secret",
        ...
        actions: [
          [
            "Create in GitHub",
            "Posts Geetorus's manifest to GitHub; GitHub confirms the App, redirects back, and Geetorus exchanges the one-time code for credentials.",
          ],
          [
      ...
      },
      {
        ...
        groups: [
          {
            ...
            rows: [
              ["Agent", "Maya · permanently assigned", "Locked"],
              ["GitHub App", "geetorus-maya[bot]", "Created"],
          ...
          },
          {
            ...
            rows: [
              ...
              [
                "Repository access",
                "Choose all repositories or a selected set; Geetorus can narrow this later.",
                "In GitHub",
              ],
              [
                "Permissions",
          ...
          },
          {
            ...
            rows: [
              [
                "Installation",
                "Geetorus links the App installation to this endpoint.",
                "Automatic return",
              ],
              [
                "Repository inventory",
                "Geetorus reads the installed repository IDs and labels.",
                "Automatic",
              ],
            ],
          },
        ...
        annotations: [
          ...
          "Geetorus receives the installation ID and repository inventory automatically.",
        ],
        rationale:
      ...
      },
      {
        ...
        groups: [
          {
            title: "Installation complete",
            intro:
              "Geetorus verified the App, installation, selected repositories, events, and signatures.",
            rows: [
              ["Agent", "Maya · permanently assigned", "Locked"],
          ...
          },
          {
            title: "Start the first task",
            intro:
              "Use an existing GitHub conversation; Geetorus does not create a second native thread.",
            rows: [
              [
              ...
              [
                "2. Mention the App",
                "Comment “@geetorus-maya investigate this.”",
                "Starts task",
              ],
              [
                "3. Watch the comment",
        ...
        actions: [
          [
            "Open GitHub",
            "Opens an installed repository while Geetorus waits for the first signed mention event.",
          ],
          [
            "Finish without testing",
      ...
      },
      {
        ...
        groups: [
          {
            ...
            intro:
              "Geetorus verifies rather than asks the user to re-enter provider configuration.",
            rows: [
              [
                "Webhook and events",
                "Geetorus callback · issue comments · PR review comments",
                "Will verify",
              ],
              [
                "Permissions",
        ...
        annotations: [
          ...
          "Geetorus verifies events and permissions instead of adding more setup switches.",
    ...
    screens: [
      {
        ...
        subtitle:
          "Run one guided Microsoft command to create the customer-owned bot identity and point it at Geetorus.",
        rail: [
          "Agent selected",
          "Register Teams bot",
          "Connect identity",
        ...
        groups: [
          ...
          },
          {
            ...
            rows: [
              ...
              [
                "Messaging endpoint",
                "Geetorus generated the verified endpoint used by the command.",
                "Prepared",
              ],
              [
                "Tenant policy",
          ...
          },
          {
            ...
            intro:
              "The copied command contains Maya's name and Geetorus endpoint; it never contains a Geetorus secret.",
            rows: [
              [
                "Microsoft sign-in",
      ...
      },
      {
        ...
        subtitle:
          "Paste the three values created by Microsoft so Geetorus can authenticate as Maya.",
        rail: [
          "Agent selected",
          "Register Teams bot",
          "Connect identity",
        ...
        fields: [
          ...
          [
            "Client secret",
            "••••••••••••",
            "Lets Geetorus authenticate outbound bot messages; stored write-only.",
          ],
        ],
        groups: [
          {
            ...
            intro:
              "Microsoft created a customer-owned identity. It does not send those credentials to Geetorus through an installation callback.",
            rows: [
              [
                "Storage",
                "Client secret enters Geetorus's secret store; configuration keeps only its reference.",
                "Write only",
              ],
              [
                "Rotation",
              ...
              [
                "Managed identity",
                "Available only when the Geetorus deployment already runs with a compatible Azure identity.",
                "Instance advanced",
              ],
            ],
          },
      ...
      },
      {
        ...
        groups: [
          {
            title: "Package ready",
            intro:
              "Geetorus inserted Maya's immutable identity, bot App ID, supported scopes, commands, and icons into a validated Teams package.",
            rows: [
              ["Agent", "Maya · permanently assigned", "Locked"],
              ["Package", "maya-geetorus-teams.zip", "Validated"],
        ...
        annotations: [
          ...
          "The screen branches only on Microsoft tenant policy, not Geetorus preferences.",
      ...
      },
      {
        ...
        groups: [
          {
            ...
            intro:
              "Geetorus verifies Microsoft identity and waits for the installed package to deliver a real activity.",
            rows: [
              ["Agent", "Maya · permanently assigned", "Locked"],
          ...
          },
          {
            ...
            rows: [
              [
                "Channel",
                "Create a new post with @Maya; its replies become one Geetorus task.",
                "Post thread",
              ],
              [
                "Personal or group chat",
                "Send a message; the conversation exposes one active Geetorus task.",
                "Active task",
              ],
              [
                "Unmentioned channel replies",
                "Geetorus detects actual manifest/RSC delivery and explains if another mention is required.",
                "Verified live",
              ],
            ],
          },
        ...
        actions: [
          [
            ...
            "Opens Teams while Geetorus waits for the first authenticated activity from an installed scope.",
          ],
          [
            "Finish without testing",
    ...
    screens: [
      {
        ...
        groups: [
          {
            title: "Agent",
            intro:
              "The Telegram bot is permanently assigned to this Geetorus agent.",
            rows: [
              [
                "Maya",
                "Support engineer · a new connection is required for another agent",
          ...
          {
            title: "What Geetorus handles",
            intro: "The token is enough for Geetorus to configure the rest.",
            rows: [
              [
                "Identity",
        ...
        actions: [
          ...
          [
            "Open BotFather",
            "Opens Telegram's verified BotFather conversation; it cannot return the token to Geetorus automatically.",
          ],
        ],
        annotations: [
      ...
      },
      {
        ...
        groups: [
          {
            title: "Bot connected",
            intro:
              "Geetorus verified the BotFather token and configured delivery automatically.",
            rows: [
              ["Agent", "Maya · permanently assigned", "Locked"],
              [
                "Telegram identity",
          ...
          },
          {
            ...
            intro:
              "Telegram owns chat membership; Geetorus learns stable IDs when the bot receives an addressed message.",
            rows: [
              [
                "Direct messages",
                "Anyone who opens the bot can start an active task, subject to Geetorus access policy.",
                "Available",
              ],
              [
                "Groups",
        ...
        actions: [
          ...
          [
            "Continue",
            "Advances to live verification; Geetorus does not require pre-entered numeric chat IDs during setup.",
          ],
        ],
        annotations: [
        ...
        rationale:
          "People choose Telegram reach by adding the bot in Telegram, not by configuring a Geetorus allowlist before any chat IDs exist.",
      },
      {
        id: "52",
        slug: "telegram-try",
        ...
        subtitle:
          "Send one addressed message so Geetorus can verify the bot, chat, and task boundary.",
        rail: [
          "Agent selected",
          "Create Telegram bot",
          "Add to chats",
        ...
        groups: [
          ...
          },
          {
            ...
            rows: [
              [
                "Direct message",
                "Send any message; it creates Maya's active Geetorus task.",
                "DM",
              ],
              [
                "Ordinary group",
          ...
          },
          {
            title: "Live verification",
            intro:
              "Geetorus records the first stable chat/user IDs and verifies a safe reply, post/edit behavior, and callbacks.",
            rows: [
              [
                "Telegram update",
        ...
        actions: [
          [
            "Open Telegram",
            "Opens Maya's bot profile while Geetorus waits for the first verified update.",
          ],
          [
            "Finish without testing",
