    ...
    screens: [
      {
        ...
        subtitle: "Bring your own Slack app using Geetorus's prepared manifest.",
      ...
      },
      {
        ...
        annotations: [
          ...
          "The instructions teach the root-mention-to-thread Geetorus task boundary.",
    ...
    screens: [
      {
        ...
        subtitle: "Create a dedicated GitHub App from Geetorus's prepared manifest.",
      ...
      },
      {
        ...
        instructions: [
          ...
          ["Mention Maya", "Add a comment: “@geetorus-maya help me test this.”"],
          ["Continue", "Add another comment in the same issue or pull request to continue the same Geetorus task."]
        ],
        primary: "Open GitHub",
        actions: [
      ...
      },
      {
        ...
        active: 1,
        mode: "advanced",
        copyValue: ["Webhook URL and secret", "Copy Geetorus webhook settings"],
        instructions: [
          ["Update the webhook", "In the GitHub App settings, paste Geetorus's URL and generated secret, then make the webhook active."],
        ...
        annotations: [
          ...
          "Only App ID and private key return to Geetorus; the generated webhook secret is already stored.",
    ...
    screens: [
      {
        ...
        active: 1,
        mode: "default",
        code: "npx @geetorusai/teams-connect --setup PC-7K4M",
        instructions: [
      ...
      },
      {
        ...
        annotations: [
          ...
          "Tenant approval is handled by Microsoft's install experience, not another Geetorus choice."
        ],
      ...
      },
      {
        ...
        instructions: [
          ...
          ["Continue in replies", "Reply once beneath that post; the post and its replies are one Geetorus task."]
        ],
      ...
      },
      {
        ...
        active: 1,
        mode: "advanced",
        copyValue: ["Messaging endpoint", "Copy Geetorus endpoint"],
        instructions: [
          ["Create the Microsoft identity", "Create a single-tenant Entra App registration and a client secret."],
          ["Create the bot", "Create an Azure Bot with that App ID, enable the Microsoft Teams channel, and paste Geetorus's messaging endpoint."],
        ...
        annotations: [
          "The copy control provides the one Geetorus value required by Microsoft.",
          "Every instruction is a portal operation the tenant administrator must perform.",
          "The three fields are the minimum identity values Geetorus needs to send as the bot.",
