...
This is intentionally separate from the normal Geetorus dev image.
...
```sh
review-checkout-pr geetorusai/geetorus 432
cd /work/checkouts/geetorusai-geetorus/pr-432
```
...
## Preview the Geetorus app from the PR
...
- Geetorus's embedded PostgreSQL and local storage stay inside the container home volume via `GEETORUS_HOME=/home/reviewer/.geetorus-review`.
