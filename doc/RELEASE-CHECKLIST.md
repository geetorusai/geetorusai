...
- [ ] `npm view geetorusai@canary version` matches the expected canary
...
- [ ] `npm view geetorusai@nightly version` shows the new `-nightly.N`
...
- [ ] `npm view geetorusai@beta version` shows the new `-beta.N`
...
- [ ] `npm view geetorusai version` (dist-tag `latest`) shows the stable
