...
> - Geetorus controls the access that agents receive to external resources.
...
agents, and let them inspect and operate Railway resources through Geetorus.
...
- [x] I have not referenced internal Geetorus issues
...
#7861 concern hosting Geetorus on Railway, not governing Railway through Apps.
