...
- Subject: `[Geetorus E2E] Daytona sandbox — Sep 11`.
- Provider key remained in Geetorus's vault. The sandbox used its injected
  Geetorus run credential, and the model key was separately vaulted.
