...
import { createAgentKeySchema, createBoardApiKeySchema, type Agent } from "@geetorusai/shared";
import {
...
export function registerTokenCommands(program: Command): void {
  const token = program.command("token").description("Manage Geetorus API tokens");
