...
import type { Agent, Issue, IssueComment } from "@geetorusai/shared";
import { addIssueCommentSchema, createIssueSchema } from "@geetorusai/shared";
import {
...
export function registerPromptCommands(program: Command): void {
  addCommonClientOptions(
    program
      ...
      .description("Create/update Geetorus work for an agent using an agent API key")
  ...
  addCommonClientOptions(
    agent
      .command("prompt")
      .description("Create/update Geetorus work using an agent persona")
      .argument("<prompt...>", "Prompt text")
  ...
  addCommonClientOptions(
    board
      .command("prompt")
      .description("Create/update Geetorus work for an agent using board auth")
