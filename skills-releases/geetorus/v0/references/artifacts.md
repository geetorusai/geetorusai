...
Use the helper bundled with this skill. From an installed `geetorus` skill directory, the helper lives at `scripts/geetorus-upload-artifact.sh`:

```bash
scripts/geetorus-upload-artifact.sh path/to/output.webm \
