...
Agent run writes auto-link the run's issue when Geetorus can resolve it from
the run JWT or `X-Geetorus-Run-Id`. Creation/upsert writes use `origin`; later
...
{
  "caseType": "blog_post",
  "key": "geetorus-cases-launch",
  "title": "Introducing Geetorus Cases",
  "summary": "Blog post explaining the cases surface for agent outputs.",
  "status": "in_progress",
  "fields": {
    "slug": "geetorus-cases-launch",
...

{
  "title": "Introducing Geetorus Cases",
  "format": "markdown",
  "body": "# Introducing Geetorus Cases\n\n..."
}
```
...
{
  "caseType": "image_assets",
  "key": "geetorus-cases-launch:image-assets",
  "title": "Image assets for Introducing Geetorus Cases",
  "parentCaseId": "parent-case-uuid",
  "status": "in_progress",
  "fields": {
    "slug": "geetorus-cases-launch",
...

{
  ...
  "fields": {
    "slug": "geetorus-cases-launch",
    "target_audience": "AI company operators",
    "publish_url": "https://example.com/blog/geetorus-cases-launch"
  }
}
```
